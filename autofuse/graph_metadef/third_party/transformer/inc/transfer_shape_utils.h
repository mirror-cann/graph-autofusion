...
enum class TransferShapeType { ND_TO_ND = 0, ND_TO_NZ, FULL_SIZE, NOT_FULL_SIZE, INVALID };
...
class TransferShapeUtils {
 ...
 private:
  ...
  static bool TransferShapeByFormat(const ge::Format &primary_format, const AxisValue &axis_value, gert::Shape &shape);
  ...
  static bool GetFractalNzShape(const int64_t &c0, const int64_t &m0, const gert::Shape &origin_shape,
                                gert::Shape &shape);
  ...
  static bool GetFractalZWinoShape(const FormatIndex &format_index, const int64_t &c0, const gert::Shape &origin_shape,
                                   gert::Shape &shape);
