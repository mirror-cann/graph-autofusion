...
struct RangeAndFormatInfo {
  ...
  RangeAndFormatInfo(af::GeShape old_shape, std::vector<std::pair<int64_t, int64_t>> old_range,
                     std::vector<std::pair<int64_t, int64_t>> &new_range, af::Format old_format,
                     af::Format new_format, af::DataType current_data_type) :
  ...
  RangeAndFormatInfo(af::GeShape old_shape, std::vector<std::pair<int64_t, int64_t>> old_range,
                     std::vector<std::pair<int64_t, int64_t>> &new_range, af::Format old_format,
                     af::Format new_format, af::DataType current_data_type, CalcShapeExtraAttr extra_attr) :
          old_shape(old_shape), old_range(old_range), new_range(new_range), old_format(old_format),
