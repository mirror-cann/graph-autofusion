...
void OnnxUtils::AddAttrProtoForAttrsFromAttrMap(
  ...
  for (const auto &item : attr_map) {
    ...
    if (attr_type == af::proto::AttrDef::kT) {
    ...
    if (attr_type == af::proto::AttrDef::kI) {
    ...
    if (attr_type == af::proto::AttrDef::kF) {
...
void OnnxUtils::AddListAttrProto(const std::string &attr_name,
  ...
  if (list_value_type == af::proto::AttrDef_ListValue_ListValueType::AttrDef_ListValue_ListValueType_VT_LIST_FLOAT) {
  ...
  if (list_value_type == af::proto::AttrDef_ListValue_ListValueType::AttrDef_ListValue_ListValueType_VT_LIST_INT) {
    const auto &ints = list_value.i();
    AddAttrProto(node_proto, onnx::AttributeProto_AttributeType_INTS, prefix + attr_name + suffix, ints);
  }
  if (list_value_type == af::proto::AttrDef_ListValue_ListValueType::AttrDef_ListValue_ListValueType_VT_LIST_BOOL) {
...
void OnnxUtils::AddCommonAttrIntoProto(onnx::NodeProto *const node_proto, const OpDescPtr &op_desc) {
  ...
  google::protobuf::Map<std::string, ::af::proto::AttrDef> op_def_attr_map;
...
void OnnxUtils::DecodeAttribute(const af::onnx::AttributeProto &attr_proto, std::vector<std::string> &strings) {
  if (attr_proto.type() != af::onnx::AttributeProto_AttributeType_STRINGS) {
...
void OnnxUtils::DecodeAttribute(const af::onnx::AttributeProto &attr_proto, std::string &value) {
  if (attr_proto.type() != af::onnx::AttributeProto_AttributeType_STRING) {
    REPORT_INNER_ERR_MSG("E18888", "Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    GELOGE(GRAPH_FAILED, "[Check][Param] Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    return;
  }
...
void OnnxUtils::DecodeAttribute(const af::onnx::AttributeProto &attr_proto, std::vector<int64_t> &ints) {
  if (attr_proto.type() != af::onnx::AttributeProto_AttributeType_INTS) {
    REPORT_INNER_ERR_MSG("E18888", "Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    GELOGE(GRAPH_FAILED, "[Check][Param] Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    return;
  }
...
void OnnxUtils::DecodeAttribute(const af::onnx::AttributeProto &attr_proto, int64_t &value) {
  if (attr_proto.type() != af::onnx::AttributeProto_AttributeType_INT) {
    REPORT_INNER_ERR_MSG("E18888", "Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    GELOGE(GRAPH_FAILED, "[Check][Param] Attribute %s call wrong decode attribute function", attr_proto.name().c_str());
    return;
  }
