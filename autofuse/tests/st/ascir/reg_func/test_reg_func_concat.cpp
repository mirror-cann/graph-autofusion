...
namespace af{
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_Size4)
 {
     ...
     Expression minTempSize = sym::Min(af::Symbol(65536),
      sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), s2), 8) + af::Symbol(29)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(4)));
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_NotLastAxis_Size4)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
      sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), sym::Mul(s2, s1)), 8) + af::Symbol(29)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(4)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_Size2)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), s2), 16) + af::Symbol(45)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(2)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_NotLastAxis_Size2)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), sym::Mul(s2, s1)), 16) + af::Symbol(45)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(2)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_Size1)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), s2), 32) + af::Symbol(93)) * af::Symbol(16) * af::Symbol(3) * af::Symbol(1)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_NotLastAxis_Size1)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(2) * sym::Max(af::Symbol(0), sym::Mul(s2, s1)), 32) + af::Symbol(93)) * af::Symbol(16) * af::Symbol(3) * af::Symbol(1)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_Size8)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(4) * sym::Max(af::Symbol(0), s2), 8) + af::Symbol(29)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(4)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
 ...
 TEST_F(CalcConcatTmpSizeTest, CalcConcatTmpSize_ShouldReturnCorrectSize_WhenNodelsValid_NotLastAxis_Size8)
 {
     ...
     ASSERT_EQ(result.size(), 1);
     Expression minTempSize = sym::Min(af::Symbol(65536),
       sym::Max(af::Symbol(16384), (sym::Align(af::Symbol(4) * sym::Max(af::Symbol(0), sym::Mul(s2, s1)), 8) + af::Symbol(29)) * af::Symbol(16) * af::Symbol(2) * af::Symbol(4)));
     ASSERT_EQ(result[0]->size, minTempSize);
     ASSERT_EQ(result[0]->life_time_axis_id, -1);
 }
