...
void LoadWhereStore_BeforeAutofuse(af::AscGraph &graph) {
...
void LoadWhereStore_AfterGetApiInfo(af::AscGraph &graph) {
  auto x1 = graph.FindNode("x1");
...
void LoadWhereStore_AfterScheduler(af::AscGraph &graph) {
...
void LoadWhereStore_AfterQueBufAlloc(af::AscGraph &graph) {
  auto x1 = graph.FindNode("x1");
