...
extern "C" __global__ __aicore__ void load_compare_int64_tensor_eq_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR y,
                                                                         GM_ADDR workspace, GM_ADDR tiling);
extern "C" void GetTiling(AutofuseTilingData &tiling_data);

class E2E_LoadCompareInt64TensorEqStore_Code : public testing::Test,
...
TEST_P(E2E_LoadCompareInt64TensorEqStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_compare_int64_tensor_eq_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y,
