...
class E2E_LoadBroadcastShapeOneStoreTest_Code : public testing::Test,
...
TEST_P(E2E_LoadBroadcastShapeOneStoreTest_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_store, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y1, (uint8_t *)y2, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_LoadBroadcastShapeOneStoreTest_Code,
                         ::testing::Values(std::vector<int>{8, 128}, std::vector<int>{15, 128},
