...
TEST_F(LoadRsumBlkStoreSt, reduceSumTest) {
  ...
  af::AscGraph test_graph("load_rsum_store_block");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("load_rsum_store_block_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_rsum_store_block");
  ...
  try {
    ...
    fused_schedule_result_int32_blk.fused_graph_name = af::AscendString("load_rsum_store_int32_block");
