...
void MultiGroupDoScheduler(ascir::FusedScheduledResult &fused_schedule_result,
  ...
  data0->attr.api.unit = af::ComputeUnit::kUnitNone;
  data0->outputs[0].attr.mem.tensor_id = 0;
  auto &attr0 = reinterpret_cast<af::AscDataIrAttrDef &>(*data0->attr.ir_attr);
  attr0.SetIndex(0);
  ...
  load0->outputs[0].attr.mem.alloc_type = af::AllocType::kAllocTypeQueue;
  load0->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareUB;
  load0->outputs[0].attr.mem.position = af::Position::kPositionVecIn;
  ...
  store0->attr.api.unit = af::ComputeUnit::kUnitMTE2;
  ...
  store0->outputs[0].attr.mem.alloc_type = af::AllocType::kAllocTypeGlobal;
  store0->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareGM;
  store0->outputs[0].attr.mem.position = af::Position::kPositionGM;
  store0->outputs[0].attr.buf.id = af::kIdNone;
  store0->outputs[0].attr.que.id = af::kIdNone;
  store0->outputs[0].attr.opt.ref_tensor = af::kIdNone;
  store0->outputs[0].attr.opt.merge_scope = af::kIdNone;

  auto workspace0_1 = impl_graphs_group[0].FindNode("workspace0");
  workspace0_1->attr.api.unit = af::ComputeUnit::kUnitNone;
  workspace0_1->outputs[0].attr.dtype = ge::DT_FLOAT16;
  workspace0_1->outputs[0].attr.mem.tensor_id = 3;
  workspace0_1->outputs[0].attr.mem.alloc_type = af::AllocType::kAllocTypeGlobal;
  workspace0_1->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareGM;
  workspace0_1->outputs[0].attr.mem.position = af::Position::kPositionGM;
  ...
  data1->attr.api.unit = af::ComputeUnit::kUnitNone;
  data1->outputs[0].attr.mem.tensor_id = 4;
  data1->outputs[0].attr.mem.alloc_type = af::AllocType::kAllocTypeGlobal;
  data1->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareGM;
  data1->outputs[0].attr.mem.position = af::Position::kPositionGM;
  auto &attr1 = reinterpret_cast<af::AscDataIrAttrDef &>(*data1->attr.ir_attr);
  attr1.SetIndex(1);

  auto workspace0_2 = impl_graphs_group[1].FindNode("workspace0");
  workspace0_2->attr.api.unit = af::ComputeUnit::kUnitNone;
  workspace0_2->outputs[0].attr.dtype = ge::DT_FLOAT16;
  workspace0_2->outputs[0].attr.mem.tensor_id = 3;
  workspace0_2->outputs[0].attr.mem.alloc_type = af::AllocType::kAllocTypeGlobal;
  workspace0_2->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareGM;
  workspace0_2->outputs[0].attr.mem.position = af::Position::kPositionGM;
  ...
  add->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareUB;
  add->outputs[0].attr.mem.position = af::Position::kPositionVecOut;
  add->outputs[0].attr.buf.id = af::kIdNone;
  ...
  add->outputs[0].attr.opt.ref_tensor = af::kIdNone;
  ...
  store1->outputs[0].attr.mem.hardware = af::MemHardware::kMemHardwareGM;
  store1->outputs[0].attr.mem.position = af::Position::kPositionGM;
  store1->outputs[0].attr.buf.id = af::kIdNone;
  store1->outputs[0].attr.que.id = af::kIdNone;
  store1->outputs[0].attr.opt.ref_tensor = af::kIdNone;
  store1->outputs[0].attr.opt.merge_scope = af::kIdNone;

  auto output0 = impl_graphs_group[1].FindNode("output0");
  output0->attr.api.unit = af::ComputeUnit::kUnitNone;
  output0->attr.api.type = af::ApiType::kAPITypeBuffer;
  output0->attr.api.compute_type = af::ComputeType::kComputeInvalid;
  auto &out_attr = reinterpret_cast<af::AscDataIrAttrDef &>(*output0->attr.ir_attr);
  out_attr.SetIndex(0);
 ...
 *            data0
 */
void ConstructMultiGroupGraph(af::AscGraph &graph, ascir::FusedScheduledResult &fused_schedule_result) {
  ...
  *abs.y.strides = {s1, One};
  abs.attr.tmp_buffers = {{{af::Symbol(8192), -1}, af::MemAttr(), 0}};
...
TEST_F(ScheduleMultiGoupTest, ScheduleMultiGoupCodegen) {
  ...
  af::AscGraph graph("schedule_multi_group");
  ascir::FusedScheduledResult fused_schedule_result;
  fused_schedule_result.fused_graph_name = af::AscendString("schedule_multi_group");
