...
TEST_F(LoadSridedSliceStoreUT, LoadSridedSliceStoreCodegen) {
  af::AscGraph test_graph("load_strided_slice_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("load_strided_slice_store_general_0_nil_0_nil")};
  ...
  fused_schedule_result.fused_graph_name = af::AscendString("load_strided_slice_store");
