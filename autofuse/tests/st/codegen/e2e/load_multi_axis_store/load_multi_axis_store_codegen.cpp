...
TEST_F(LoadMultiAxisStoreTest, LoadMultiAxisStoreCodegen) {
  ...
  af::AscGraph graph("load_multi_axis_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> impl_graph = {af::AscGraph("load_multi_axis_store_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_multi_axis_store");
