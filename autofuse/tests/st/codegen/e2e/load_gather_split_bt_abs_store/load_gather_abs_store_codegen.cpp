...
TEST_F(LoadGather_BT_AbsStoreST, LoadGather_BT_AbsStoreCodegen) {
  ...
  af::AscGraph graph("load_gather_abs_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  af::AscGraph impl_graph("load_gather_abs_store_general_0_nil_0_nil");
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_gather_abs_store");
