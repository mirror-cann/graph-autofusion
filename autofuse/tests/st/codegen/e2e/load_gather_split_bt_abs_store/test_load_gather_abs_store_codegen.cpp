...
class E2E_Load_Gather_BT_Abs_Store : public testing::Test,
                                     public testing::WithParamInterface<std::pair<std::vector<int>, std::vector<int>>> {
};

TEST_P(E2E_Load_Gather_BT_Abs_Store, Gather_BT_AbsTest) {
...
INSTANTIATE_TEST_SUITE_P(M32_K_BlockAlign, E2E_Load_Gather_BT_Abs_Store,
                         ::testing::Values(std::pair<std::vector<int>, std::vector<int>>{{2, 2, 4, 4, 7}, {2, 4}}));
