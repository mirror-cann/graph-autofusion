...
TEST_F(LoadStoreUT, DiscreteStoreCodegen) {
  ...
  af::AscGraph test_graph("store_scalar");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("store_scalar_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("store_scalar");
