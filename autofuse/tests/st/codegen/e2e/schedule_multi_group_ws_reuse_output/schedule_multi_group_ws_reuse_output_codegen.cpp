...
void MultiGroupDoScheduler(ascir::FusedScheduledResult &fused_schedule_result,
  ...
  output1->attr.api.unit = af::ComputeUnit::kUnitNone;
  output1->attr.api.type = af::ApiType::kAPITypeBuffer;
  output1->attr.api.compute_type = af::ComputeType::kComputeInvalid;
  auto &out_attr1 = reinterpret_cast<af::AscDataIrAttrDef &>(*output1->attr.ir_attr);
...
TEST_F(ScheduleMultiGoupWsReuseOutputTest, ScheduleMultiGoupWsReuseOutputCodegen) {
  ...
  fused_schedule_result.fused_graph_name = af::AscendString("schedule_multi_group_ws_reuse_output");
