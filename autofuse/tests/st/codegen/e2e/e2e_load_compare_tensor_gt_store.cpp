...
void LoadCompareTensorGtStore_BeforeAutofuse(af::AscGraph &graph, ge::DataType data_type) {
...
void LoadCompareTensorGtStore_AfterInferOutput(af::AscGraph &graph, ge::DataType data_type) {
...
void LoadCompareTensorGtStore_AfterGetApiInfo(af::AscGraph &graph) {
  auto x1 = graph.FindNode("x1");
...
void LoadCompareTensorGtStore_AfterScheduler(af::AscGraph &graph) {
...
void LoadCompareTensorGtStore_AfterQueBufAlloc(af::AscGraph &graph) {
  int tensor_id = 0;
...
void LoadCompareTensorGtStore_AfterAutofuse(af::AscGraph &graph, std::vector<af::AscGraph> &impl_graphs,
                                            ge::DataType data_type) {
  LoadCompareTensorGtStore_BeforeAutofuse(graph, data_type);
  LoadCompareTensorGtStore_AfterInferOutput(graph, data_type);

  impl_graphs.push_back(af::AscGraph("load_compare_half_tensor_gt_store_general_0_nil_0_nil"));
