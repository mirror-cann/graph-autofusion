...
extern "C" __global__ __aicore__ void load_ub2ub_abs_store(GM_ADDR x, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling);
...
TEST_P(E2E_LoadAbsStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_ub2ub_abs_store, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
