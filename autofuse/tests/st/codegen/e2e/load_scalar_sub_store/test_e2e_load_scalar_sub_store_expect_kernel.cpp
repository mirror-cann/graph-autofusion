...
class E2E_LoadScalarSubStore_Code : public testing::Test,
                                    public testing::WithParamInterface<std::pair<std::vector<int>, std::vector<int>>> {
};

TEST_P(E2E_LoadScalarSubStore_Code, CalculateCorrect) {
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_LoadScalarSubStore_Code,
