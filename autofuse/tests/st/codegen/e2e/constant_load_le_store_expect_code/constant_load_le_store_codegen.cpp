...
int main() {
  af::AscGraph test_graph("constant_load_le_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto codegen = codegen::Codegen(
      codegen::CodegenOptions{.tiling_lib_path = "./libtest_constant_load_le_store_codegen_tiling_gen.so",
  ...
  fused_schedule_result.fused_graph_name = af::AscendString("constant_load_le_store");
