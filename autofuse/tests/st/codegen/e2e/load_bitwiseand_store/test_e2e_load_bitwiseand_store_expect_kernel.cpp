...
extern "C" __global__ __aicore__ void load_bitwiseand_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace,
                                                            GM_ADDR tiling);
...
TEST_P(E2E_LoadBitwiseAndStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_bitwiseand_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
