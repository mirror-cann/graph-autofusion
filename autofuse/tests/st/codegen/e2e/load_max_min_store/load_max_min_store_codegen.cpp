...
TEST_F(LoadMaxMinStoreUT, MaxMinCodegen) {
  ...
  af::AscGraph test_graph("load_max_min_store");
  std::string tilig_stub = R"(
#define REGISTER_TILING_DEFAULT(tiling)
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
)";
  LoadMaxMinStore_BeforeAutofuse(test_graph, ge::DT_FLOAT);
  af::AscGraph impl_graph("load_max_min_store_general_0_nil_0_nil");
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_max_min_store");
...
TEST_F(LoadMaxMinStoreUT, AllReduceMax) {
  bool gen_success = true;
  af::AscGraph test_graph("all_reduce_max");
