...
extern "C" __global__ __aicore__ void load_max_min_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR x3, GM_ADDR y,
...
TEST_P(E2E_LoadMaxMinStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_max_min_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)x3, (uint8_t *)y,
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_LoadMaxMinStore_Code,
                         ::testing::Values(std::vector<int>{8, 8}, std::vector<int>{32, 64}, std::vector<int>{48, 30}));
