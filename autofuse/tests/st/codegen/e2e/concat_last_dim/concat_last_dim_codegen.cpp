...
TEST_F(ConcatLastDimUT, ConcatLastDimCodegen) {
  ...
  af::AscGraph test_graph("concat_last_dim");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("concat_last_dim_general_0_nil_0_nil")};
  ...
  fused_schedule_result.fused_graph_name = af::AscendString("concat_last_dim");
