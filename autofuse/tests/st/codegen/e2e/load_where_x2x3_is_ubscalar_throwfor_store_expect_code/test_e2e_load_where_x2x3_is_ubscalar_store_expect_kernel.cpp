...
extern "C" __global__ __aicore__ void load_where_x2x3_is_ubscalar_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR x3, GM_ADDR y,
                                                                        GM_ADDR workspace, GM_ADDR gm_tiling_data);
extern "C" void GetTiling(AutofuseTilingData &tiling_data);

class E2E_LoadWhereUint8x2x3IsUbscalarStore_Code
    : public testing::Test,
...
TEST_P(E2E_LoadWhereUint8x2x3IsUbscalarStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_where_x2x3_is_ubscalar_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)x3,
