...
extern "C" __global__ __aicore__ void concat_all_aligned_test(GM_ADDR data0, GM_ADDR data1, GM_ADDR output,
...
class E2E_BackendConcatAllAligned_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};

TEST_P(E2E_BackendConcatAllAligned_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(concat_all_aligned_test, tiling_data.block_dim, (uint8_t *)input1, (uint8_t *)input2, (uint8_t *)y,
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_BackendConcatAllAligned_Code,
                         ::testing::Values(std::vector<int>{100, 8}));
