...
extern "C" __global__ __aicore__ void load_where_x3_is_ubscalar_store_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y,
...
class E2E_LoadWhereX3IsUbscalarStore_Code
    : public testing::Test,
      public testing::WithParamInterface<std::pair<std::vector<int>, std::vector<int>>> {};

TEST_P(E2E_LoadWhereX3IsUbscalarStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_where_x3_is_ubscalar_store_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y,
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_LoadWhereX3IsUbscalarStore_Code,
