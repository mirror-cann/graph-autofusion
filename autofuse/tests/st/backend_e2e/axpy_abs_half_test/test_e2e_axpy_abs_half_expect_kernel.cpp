...
extern "C" __global__ __aicore__ void axpy_abs_half_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace,
                                                         GM_ADDR tiling);
...
TEST_P(E2E_BackendAxpyAbsHalf_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(axpy_abs_half_test, tiling_data.block_dim, (uint8_t *)input1, (uint8_t *)input2, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
