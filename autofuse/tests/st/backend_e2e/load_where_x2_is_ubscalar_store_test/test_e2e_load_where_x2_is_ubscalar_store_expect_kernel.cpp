...
extern "C" __global__ __aicore__ void load_where_x2_is_ubscalar_store_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y,
...
class E2E_LoadWhereX2IsUbscalarStore_Code
    : public testing::Test,
...
TEST_P(E2E_LoadWhereX2IsUbscalarStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_where_x2_is_ubscalar_store_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x3, (uint8_t *)y,
