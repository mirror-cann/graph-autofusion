...
#define BEGIN_TILING_DATA_DEF(struct_name) class struct_name : public TilingDef {
...
#define TILING_DATA_FIELD_DEF_STRUCT(struct_type, field_name) struct_type field_name;
