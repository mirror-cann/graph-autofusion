...
class SkipFuseConfigTest : public testing::Test {
 protected:
  ...
  void ParseAndVerifyConfig(const std::string &config_content, size_t expected_types_size, size_t expected_names_size,
...
TEST_F(SkipFuseConfigTest, ParseConfig_BothSections) {
  ...
  ParseAndVerifyConfig(config_content, 3U, 3U, {"Concat", "ReduceSum", "Add"},
...
TEST_F(SkipFuseConfigTest, ParseConfig_OnlyByNodeType) {
  ...
  ParseAndVerifyConfig(config_content, 4U, 0U, {"Concat", "ReduceSum", "Add", "Mul"});
}
...
TEST_F(SkipFuseConfigTest, ParseConfig_OnlyByNodeName) {
  ...
  ParseAndVerifyConfig(config_content, 0U, 4U, {}, {"emb_gather1", "flash_concat2", "special_layer_1", "test_node_42"});
}
