...
TEST_F(TestApiRemainder, Remainder_Float_LargeAlignedSize) {
  RemainderTestFloat(((MAX_REPEAT_NUM - 1) * ONE_REPEAT_BYTE_SIZE + (ONE_REPEAT_BYTE_SIZE - ONE_BLK_SIZE) +
...
TEST_F(TestApiRemainder, Remainder_Int32_LargeAlignedSize) {
  RemainderTestInt32(((MAX_REPEAT_NUM - 1) * ONE_REPEAT_BYTE_SIZE + (ONE_REPEAT_BYTE_SIZE - ONE_BLK_SIZE) +
