...
INSTANTIATE_TEST_SUITE_P(DiffShape, TestReduceMaxAR,
                         ::testing::Values(ReduceMaxTestParams{8, 32, true}, ReduceMaxTestParams{8, 16, true},
                                           ReduceMaxTestParams{4, 8, true}, ReduceMaxTestParams{7, 1, true},
...
INSTANTIATE_TEST_SUITE_P(DiffShape, TestReduceMaxRA,
                         ::testing::Values(ReduceMaxTestParams{8, 32, false}, ReduceMaxTestParams{8, 16, false},
                                           ReduceMaxTestParams{4, 64, false}, ReduceMaxTestParams{16, 7, false},
                                           ReduceMaxTestParams{1, 16, false}, ReduceMaxTestParams{16, 1, false}));
