...
class UTTEST_GENERAL_SOLVER_02 : public ::testing::Test {
 public:
  ...
  bool TestLocateRegion(std::vector<uint64_t> vars, std::vector<bool> update_last, int32_t thres,
...
bool UTTEST_GENERAL_SOLVER_02::TestLocateRegion(std::vector<uint64_t> vars, std::vector<bool> update_last,
                                                int32_t thres, std::vector<uint64_t> &res) {
  bool ret;
