...
TEST(WhereApiCallTest, WhereApiCall_Scaler_x2x3) {
  ...
  *where_op.y.strides = {s1 * s2, s2, One};
  ...
  EXPECT_EQ(result, std::string{"Where(local_3[0], local_0[0], local_1, local_2, local_0_actual_size, tmp_buf_0);\n"});
}
...
TEST(WhereApiCallTest, WhereApiCall_x2_x3_is_ub_scalar) {
  ...
  *where_op.y.strides = {s1 * s2, s2, One};
  ...
  EXPECT_EQ(call.Generate(tpipe, current_axis, result), 0);
  std::cout << result << std::endl;
  EXPECT_EQ(result, std::string{"Where(local_3[0], local_0[0], (float)local_1_ub_scalar, (float)local_2_ub_scalar, "
...
TEST(WhereApiCallTest, WhereApiCall) {
  ...
  *where_op.y.strides = {s1 * s2, s2, One};
  ...
  std::cout << result << std::endl;
  EXPECT_EQ(result,
            std::string{"Where(local_3[0], local_0[0], local_1[0], local_2[0], local_0_actual_size, tmp_buf_0);\n"});
}
...
TEST(WhereApiCallTest, WhereApiCall_throwfor) {
  ...
  *where_op.y.strides = {s1 * s2, s2, One};
  ...
  EXPECT_EQ(call.Generate(tpipe, current_axis, result), 0);
  std::cout << result << std::endl;
  EXPECT_EQ(result, std::string{"Where<false, false>(local_3[0], local_0[0], local_1[0], local_0[0], t->s1, t->s2, "
                                "t->s2, t->s2, t->s2, t->s2, tmp_buf_0, 0);\n"});
}
