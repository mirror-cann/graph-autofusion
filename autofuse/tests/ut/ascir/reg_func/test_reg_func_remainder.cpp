...
extern std::vector<std::unique_ptr<af::TmpBufDesc>> CalcRemainderTmpSize(const af::AscNode &node);
...
// Test: Ub-Scalar input (second input repeats all 1)
...
// Test: Scalar input (second input is scalar with no repeats)
