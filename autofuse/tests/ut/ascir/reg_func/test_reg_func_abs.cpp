...
namespace af{
namespace ascir{
extern std::vector<std::unique_ptr<af::TmpBufDesc>> CalcAbsTmpSize(const af::AscNode &node);
...
TEST_F(CalcAbsTmpSizeTest, CalcAbsTmpSizeWhenInt32)
{
    ...
    *y.y.strides = {s1, Symbol(1)};
    ...
    std::vector<std::unique_ptr<af::TmpBufDesc>> result = CalcAbsTmpSize(*node);
