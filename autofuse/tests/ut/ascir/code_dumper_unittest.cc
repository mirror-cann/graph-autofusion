...
void ConstructAscGraph(AscGraph &graph) {
  ...
  scalar.y.dtype = af::DT_FLOAT16;
  scalar.y.format = af::FORMAT_ND;
  ...
  *concat.y.strides = {s1 * af::Symbol(2), sym::kSymbolOne};
  ...
  fake_opa.y.dtype = af::DT_FLOAT16;
  fake_opa.y.format = af::FORMAT_ND;
