...
class E2E_Load_Broadcast_Store : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};
...
TEST_P(E2E_Load_Broadcast_Store, BroadCastLast111) {
  ...
  ICPU_RUN_KF(load_broadcast_store, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(M32_K_BlockAlign, E2E_Load_Broadcast_Store,
                         ::testing::Values(std::vector<int>{48 * 4 * 8, 16}, std::vector<int>{48 * 4 * 16, 16},
                                           std::vector<int>{48 * 4 * 32, 16}, std::vector<int>{48 * 4 * 64, 16},
                                           std::vector<int>{48 * 4 * 128, 16}, std::vector<int>{48 * 4 * 8, 512},
                                           std::vector<int>{48 * 4 * 8, 256}, std::vector<int>{48 * 4 * 8, 128},
                                           std::vector<int>{48 * 4 * 8, 64}, std::vector<int>{48 * 4 * 8, 32}));

extern "C" __global__ __aicore__ void load_broadcast_store_int64(GM_ADDR x, GM_ADDR y, GM_ADDR workspace,
                                                                 GM_ADDR tiling);

class E2E_Load_Broadcast_Store_Int64 : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};
...
TEST_P(E2E_Load_Broadcast_Store_Int64, BroadCastLast111_int64) {
  ...
  AscendC::SetKernelMode(KernelMode::AIV_MODE);
  ICPU_RUN_KF(load_broadcast_store_int64, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(M32_K_BlockAlign, E2E_Load_Broadcast_Store_Int64,
                         ::testing::Values(std::vector<int>{48 * 4 * 8, 16}, std::vector<int>{48 * 4 * 8, 256},
                                           std::vector<int>{48 * 4 * 8, 128}, std::vector<int>{48 * 4 * 8, 64},
                                           std::vector<int>{48 * 4 * 8, 32}));

extern "C" __global__ __aicore__ void load_broadcast_store_uint8(GM_ADDR x, GM_ADDR y, GM_ADDR workspace,
                                                                 GM_ADDR tiling);

class E2E_Load_Broadcast_Store_uint8 : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};
...
TEST_P(E2E_Load_Broadcast_Store_uint8, BroadCastLast111_uint8) {
  ...
  AscendC::SetKernelMode(KernelMode::AIV_MODE);
  ICPU_RUN_KF(load_broadcast_store_uint8, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(M32_K_BlockAlign, E2E_Load_Broadcast_Store_uint8,
                         ::testing::Values(std::vector<int>{48 * 4 * 7, 50}, std::vector<int>{48 * 4 * 15, 23},
                                           std::vector<int>{48 * 4 * 23, 31}, std::vector<int>{48 * 4 * 50, 15},
                                           std::vector<int>{48 * 4 * 8, 200}, std::vector<int>{48 * 4 * 8, 100},
                                           std::vector<int>{48 * 4 * 8, 64}, std::vector<int>{48 * 4 * 8, 32}));
