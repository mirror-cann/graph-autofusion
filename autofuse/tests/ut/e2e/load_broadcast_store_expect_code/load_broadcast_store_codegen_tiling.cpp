...
extern "C" bool CodegenTiling_int64(const std::string &op_name, const std::vector<af::AscGraph> &graphs,
                              std::map<std::string, std::string> &options,
                              std::map<std::string, std::string> &tiling_func) {
  std::stringstream ss;

  ss << OptilingStub() << std::endl;
  ss << "extern \"C\" void GetTiling_int64(AutofuseTilingData& tiling_data) {" << std::endl;
  ss << "  tiling_data.set_z0Tb_size(4);" << std::endl;
  ss << "  tiling_data.set_z0t_size(tiling_data.get_s0() / 48 / 4);" << std::endl;
  ss << "  tiling_data.set_z1t_size(tiling_data.get_s1());" << std::endl;
  ss << "}" << std::endl;
...
extern "C" bool CodegenTiling_uint8(const std::string &op_name, const std::vector<af::AscGraph> &graphs,
                              std::map<std::string, std::string> &options,
                              std::map<std::string, std::string> &tiling_func) {
  std::stringstream ss;

  ss << OptilingStub() << std::endl;
  ss << "extern \"C\" void GetTiling_uint8(AutofuseTilingData& tiling_data) {" << std::endl;
  ss << "  tiling_data.set_z0Tb_size(4);" << std::endl;
  ss << "  tiling_data.set_z0t_size(tiling_data.get_s0() / 48 / 4);" << std::endl;
  ss << "  tiling_data.set_z1t_size(tiling_data.get_s1());" << std::endl;
  ss << "}" << std::endl;
