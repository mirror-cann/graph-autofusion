...
inline Tensor AccumulatorApplyGradient(const Tensor &handle, const Tensor &local_step, const Tensor &gradient, af::DataType dtype) {
...
inline Tensor Bucketize(const Tensor &x, const std::vector<float> &boundaries, af::DataType dtype=af::DT_INT32, bool right=true) {
...
inline Tensor ConditionalAccumulator(const Graph &owner_graph, af::DataType dtype, const std::vector<int64_t> &shape, const char *container="", const char *shared_name="", const char *reduction_type="MEAN") {
...
inline Tensor CropAndResizeGradImage(const Tensor &grads, const Tensor &boxes, const Tensor &box_index, const Tensor &image_size, af::DataType T, const char *method="bilinear") {
...
inline Tensor CropAndResizeV2(const Tensor &x, const Tensor &boxes, const Tensor &box_index, const Tensor &crop_size, float extrapolation_value=0.000000, const char *method="bilinear", af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor DecodeImage(const Tensor &contents, int64_t channels=0, af::DataType dtype=af::DT_UINT8, bool expand_animations=true) {
...
inline Tensor Dequeue(const Tensor &queue_id, af::DataType output_type, const std::vector<int64_t> &output_shape, const char *queue_name="") {
...
inline Tensor DropOutGenMaskV4(const Tensor &shape, const Tensor &prob, int64_t seed=0, int64_t seed2=0, af::DataType dtype=af::DT_BOOL) {
...
inline Tensor EmptyTensorList(const Tensor &element_shape, const Tensor &max_num_elements, af::DataType element_dtype=af::DT_INT32) {
...
inline Tensor FileConstant(const Graph &owner_graph, const std::vector<int64_t> &shape, af::DataType dtype, const char *file_path="", const char *file_id="") {
...
inline Tensor HashTable(const Graph &owner_graph, af::DataType key_dtype, af::DataType value_dtype, const char *container="", const char *shared_name="", bool use_node_name_sharing=false) {
...
inline HcomGatherAllToAllVOutput HcomGatherAllToAllV(const Tensor &addrinfo, const Tensor &addrinfo_count_per_rank, const Tensor &recv_counts, const Tensor &recv_displacements, const char *group, af::DataType dtype, int64_t addr_length) {
...
inline Tensor HcomReceive(const Graph &owner_graph, const char *group, int64_t sr_tag, int64_t src_rank, const std::vector<int64_t> &shape, af::DataType dtype) {
...
inline Tensor HcomRemoteRefRead(const Tensor &remote, const Tensor &cache_var, const Tensor &local_offset, af::DataType dtype) {
...
inline Tensor IndexToAddr(const Tensor &base_addr, const Tensor &x, const std::vector<int64_t> &ori_shape, const std::vector<int64_t> &block_size, const char *ori_storage_mode="Matrix", const char *block_storage_mode="Matrix", int64_t rank_id=0, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor InitEmbeddingHashmap(const Tensor &table_id, int64_t value_total_len, int64_t embedding_dim, int64_t bucket_size=0, af::DataType dtype=af::DT_FLOAT, const char *initializer_mode="", float constant_value=0.000000, float min=-2.000000, float max=2.000000, float mu=0.000000, float sigma=1.000000, int64_t seed=0, int64_t seed2=0, const char *filter_mode="no_filter", const char *optimizer_mode="", const std::vector<float> &optimizer_params={}) {
...
inline Tensor InitEmbeddingHashmapV2(const Tensor &table_id, int64_t bucket_size, int64_t load_factor, int64_t embedding_dim, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor LookupTableFind(const Tensor &handle, const Tensor &keys, const Tensor &default_value, af::DataType Tout) {
...
inline Tensor LruCache(const Graph &owner_graph, af::DataType dtype, const char *container="", const char *shared_name="LruCache", int64_t cache_size=100000, float load_factor=1.000000) {
...
inline Tensor Multinomial(const Tensor &logits, const Tensor &num_samples, af::DataType dtype=af::DT_INT64, int64_t seed=0, int64_t seed2=0) {
...
inline Tensor MutableDenseHashTable(const Tensor &empty_key, const Tensor &deleted_key, af::DataType value_dtype, const char *container="", const char *shared_name="", bool use_node_name_sharing=false, const std::vector<int64_t> &value_shape={}, int64_t initial_num_buckets=131072, float max_load_factor=0.800000) {
...
inline Tensor MutableHashTable(const Graph &owner_graph, af::DataType key_dtype, af::DataType value_dtype, const char *container="", const char *shared_name="", bool use_node_name_sharing=false) {
  auto out = EsMutableHashTable(owner_graph.GetEsbGraph(), key_dtype, value_dtype, container, shared_name, use_node_name_sharing);
  return out;
}
inline Tensor MutableHashTableOfTensors(const Graph &owner_graph, af::DataType key_dtype, af::DataType value_dtype, const char *container="", const char *shared_name="", bool use_node_name_sharing=false, const std::vector<int64_t> &value_shape={}) {
...
inline NonMaxSuppressionV5Output NonMaxSuppressionV5(const Tensor &boxes, const Tensor &scores, const Tensor &max_output_size, const Tensor &iou_threshold, const Tensor &score_threshold, const Tensor &soft_nms_sigma, af::DataType T, bool pad_to_max_output_size=false) {
...
inline NonZeroWithValueOutput NonZeroWithValue(const Tensor &x, bool transpose=false, af::DataType dtype=af::DT_INT32) {
...
inline Tensor NormalizeV2(const Tensor &x, const Tensor &mean, const Tensor &variance, af::DataType dtype=af::DT_FLOAT) {
...
inline RaggedRangeOutput RaggedRange(const Tensor &starts, const Tensor &limits, const Tensor &deltas, af::DataType Tsplits) {
...
inline RaggedTensorToSparseOutput RaggedTensorToSparse(const std::vector<Tensor> &rt_nested_splits, const Tensor &rt_dense_values, int64_t RAGGED_RANK=1, af::DataType Tsplits=af::DT_INT64) {
...
inline Tensor RandomPoisson(const Tensor &shape, const Tensor &rate, af::DataType dtype=af::DT_INT64, int64_t seed=0, int64_t seed2=0) {
...
inline Tensor ResizeBicubic(const Tensor &images, const Tensor &size, bool align_corners=false, bool half_pixel_centers=false, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor ResizeBilinearV2(const Tensor &x, const Tensor &size, bool align_corners=false, bool half_pixel_centers=false, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor ResourceConditionalAccumulator(const Graph &owner_graph, af::DataType dtype, const std::vector<int64_t> &shape, const char *container="", const char *shared_name="", const char *reduction_type="MEAN") {
...
inline Tensor SearchSorted(const Tensor &sorted_sequence, const Tensor &values, const Tensor &sorter=nullptr, af::DataType dtype=af::DT_INT64, bool right=false) {
...
inline Tensor SerializeManySparse(const Tensor &indices, const Tensor &values, const Tensor &shape, af::DataType out_type=af::DT_STRING) {
  auto out = EsSerializeManySparse(indices.GetEsbTensor(), values.GetEsbTensor(), shape.GetEsbTensor(), out_type);
  return out;
}
inline Tensor SerializeSparse(const Tensor &indices, const Tensor &values, const Tensor &shape, af::DataType out_type=af::DT_STRING) {
...
inline Tensor SobolSample(const Tensor &dim, const Tensor &num_results, const Tensor &skip, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor SparseAccumulatorApplyGradient(const Tensor &handle, const Tensor &local_step, const Tensor &indices, const Tensor &values, const Tensor &shape, bool has_known_shape, af::DataType dtype) {
...
inline SparseAccumulatorTakeGradientOutput SparseAccumulatorTakeGradient(const Tensor &handle, const Tensor &num_required, af::DataType dtype) {
...
inline Tensor SparseConditionalAccumulator(const Graph &owner_graph, const std::vector<int64_t> &shape, af::DataType dtype, const char *container="", const char *shared_name="", const char *reduction_type="MEAN") {
...
inline SparseCrossOutput SparseCross(const std::vector<Tensor> &indices, const std::vector<Tensor> &values, const std::vector<Tensor> &shapes, const std::vector<Tensor> &dense_inputs, bool hashed_output, int64_t hash_key, af::DataType out_type, af::DataType internal_type, int64_t N=0, int64_t num_buckets=0) {
  auto esb_indices = TensorsToEsbTensors(indices);
  auto esb_values = TensorsToEsbTensors(values);
  auto esb_shapes = TensorsToEsbTensors(shapes);
...
inline Tensor StatefulRandomBinomial(const Tensor &x, const Tensor &algorithm, const Tensor &shape, const Tensor &counts, const Tensor &probs, af::DataType dtype) {
...
inline Tensor StatelessBernoulli(const Tensor &shape, const Tensor &prob, const Tensor &seed, const Tensor &offset, af::DataType dtype=af::DT_FLOAT) {
  auto out = EsStatelessBernoulli(shape.GetEsbTensor(), prob.GetEsbTensor(), seed.GetEsbTensor(), offset.GetEsbTensor(), dtype);
  return out;
}
inline Tensor StatelessBernoulliV2(const Tensor &x, const Tensor &seed, const Tensor &offset, af::DataType dtype=af::DT_UNDEFINED) {
...
inline Tensor StatelessMultinomial(const Tensor &logits, const Tensor &num_samples, const Tensor &seed, af::DataType output_dtype=af::DT_INT64) {
...
inline Tensor StatelessRandomBinomial(const Tensor &shape, const Tensor &seed, const Tensor &counts, const Tensor &probs, af::DataType dtype=af::DT_INT32) {
...
inline Tensor StatelessRandomNormalV2(const Tensor &shape, const Tensor &key, const Tensor &counter, const Tensor &alg, af::DataType dtype=af::DT_FLOAT) {
...
inline Tensor StatelessRandomUniformFullInt(const Tensor &shape, const Tensor &seed, af::DataType dtype=af::DT_INT32) {
  auto out = EsStatelessRandomUniformFullInt(shape.GetEsbTensor(), seed.GetEsbTensor(), dtype);
  return out;
}
inline Tensor StatelessRandomUniformFullIntV2(const Tensor &shape, const Tensor &key, const Tensor &counter, const Tensor &alg, af::DataType dtype=af::DT_INT32) {
...
inline Tensor StatelessRandomUniformV2(const Tensor &shape, const Tensor &key, const Tensor &counter, const Tensor &alg, af::DataType dtype=af::DT_FLOAT) {
  auto out = EsStatelessRandomUniformV2(shape.GetEsbTensor(), key.GetEsbTensor(), counter.GetEsbTensor(), alg.GetEsbTensor(), dtype);
  return out;
}
inline Tensor StatelessRandperm(const Tensor &n, const Tensor &seed, const Tensor &offset, int64_t layout=0, af::DataType dtype=af::DT_INT64) {
...
inline Tensor StatelessTruncatedNormalV2(const Tensor &shape, const Tensor &key, const Tensor &counter, const Tensor &alg, af::DataType dtype=af::DT_FLOAT) {
...
inline TakeManySparseFromTensorsMapOutput TakeManySparseFromTensorsMap(const Tensor &handles, af::DataType dtype, const char *container="", const char *shared_name="") {
...
inline TensorArrayOutput TensorArray(const Tensor &size, af::DataType dtype, const std::vector<int64_t> &element_shape={-2}, bool dynamic_size=false, bool clear_after_read=true, bool identical_element_shapes=false, const char *tensor_array_name="") {
...
inline TensorArrayConcatOutput TensorArrayConcat(const Tensor &handle, const Tensor &flow_in, af::DataType dtype, const std::vector<int64_t> &element_shape_except0={-2}) {
...
inline Tensor TensorArrayGather(const Tensor &handle, const Tensor &indices, const Tensor &flow_in, af::DataType dtype, const std::vector<int64_t> &element_shape={-2}) {
...
inline Tensor TensorListConcatLists(const Tensor &input_a, const Tensor &input_b, af::DataType element_dtype=af::DT_INT32) {
...
inline TensorListConcatV2Output TensorListConcatV2(const Tensor &input_handle, const Tensor &element_shape, const Tensor &leading_dims, af::DataType element_dtype=af::DT_INT32) {
...
inline Tensor TensorListFromTensor(const Tensor &tensor, const Tensor &element_shape, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListFromTensor(tensor.GetEsbTensor(), element_shape.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListGather(const Tensor &input_handle, const Tensor &indices, const Tensor &element_shape, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListGather(input_handle.GetEsbTensor(), indices.GetEsbTensor(), element_shape.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListGetItem(const Tensor &input_handle, const Tensor &index, const Tensor &element_shape, af::DataType element_dtype=af::DT_INT32) {
...
inline TensorListPopBackOutput TensorListPopBack(const Tensor &input_handle, const Tensor &element_shape, af::DataType element_dtype=af::DT_INT32) {
...
inline Tensor TensorListPushBack(const Tensor &input_handle, const Tensor &tensor, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListPushBack(input_handle.GetEsbTensor(), tensor.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListPushBackBatch(const Tensor &input_handles, const Tensor &tensor, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListPushBackBatch(input_handles.GetEsbTensor(), tensor.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListReserve(const Tensor &element_shape, const Tensor &num_elements, af::DataType element_dtype=af::DT_INT32, af::DataType shape_type=af::DT_INT32) {
...
inline Tensor TensorListScatterIntoExistingList(const Tensor &input_handle, const Tensor &tensor, const Tensor &indices, af::DataType element_dtype=af::DT_INT32) {
...
inline Tensor TensorListScatterV2(const Tensor &tensor, const Tensor &indices, const Tensor &element_shape, const Tensor &num_elements, af::DataType element_dtype=af::DT_INT32) {
...
inline Tensor TensorListSetItem(const Tensor &input_handle, const Tensor &index, const Tensor &item, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListSetItem(input_handle.GetEsbTensor(), index.GetEsbTensor(), item.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListSplit(const Tensor &tensor, const Tensor &element_shape, const Tensor &lengths, af::DataType element_dtype=af::DT_INT32) {
  auto out = EsTensorListSplit(tensor.GetEsbTensor(), element_shape.GetEsbTensor(), lengths.GetEsbTensor(), element_dtype);
  return out;
}
inline Tensor TensorListStack(const Tensor &input_handle, const Tensor &element_shape, af::DataType element_dtype=af::DT_INT32, int64_t num_elements=-1) {
...
inline Tensor TruncatedNormal(const Tensor &shape, int64_t seed=0, int64_t seed2=0, af::DataType dtype=af::DT_FLOAT) {
...
inline UnicodeDecodeOutput UnicodeDecode(const Tensor &input, const char *input_encoding, const char *errors="replace", int64_t replacement_char=65533, bool replace_control_characters=false, af::DataType Tsplits=af::DT_INT64) {
...
inline UnicodeDecodeWithOffsetsOutput UnicodeDecodeWithOffsets(const Tensor &input, const char *input_encoding, const char *errors="replace", int64_t replacement_char=65533, bool replace_control_characters=false, af::DataType Tsplits=af::DT_INT64) {
...
inline UniqueWithCountsExt2Output UniqueWithCountsExt2(const Tensor &x, const Tensor &axis, af::DataType out_idx=af::DT_INT64, bool sorted=false, bool return_inverse=false) {
...
inline Tensor VarHandleOp(const Graph &owner_graph, af::DataType dtype, const char *container="", const char *shared_name="", const std::vector<int64_t> &shape={-1}) {
...
inline Tensor _ParallelConcatStart(const Graph &owner_graph, af::DataType dtype=af::DT_INT32, const std::vector<int64_t> &shape={}) {
