...
class UtestFusionStrategySolverV2 : public testing::Test {
 public:
  static std::shared_ptr<af::AscGraph> CreatMulAscGraph(af::AscGraph &graph, size_t out_num = 1, size_t in_num = 1) {
    auto ONE = Symbol(1);
    ...
    *x_out.y.strides = {B * C * D * E, C * D * E, D * E, E, ONE};
    ...
    return std::shared_ptr<af::AscGraph>(new af::AscGraph(graph));
  }

  static std::shared_ptr<af::AscGraph> CreatMul2InputsAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
    ...
    *x1Local.y.strides = {B * C * D * E, C * D * E, D * E, E, ONE};
    ...
    af::ascir_op::Load x2Local("load_1");
    x2Local.x = x2.y;
    x2Local.attr.sched.axis = {a.id, b.id, c.id, d.id, e.id};
    *x2Local.y.axis = {a.id, b.id, c.id, d.id, e.id};
    *x2Local.y.repeats = {A, B, C, D, E};
  ...
  static std::shared_ptr<af::AscGraph> CreatSplitAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatSplitDoubleOutPutsAscGraph(af::AscGraph &graph,
    ...
    std::vector<std::vector<af::Expression>> output_dim_sizes(split_dims.size(), {A, B, C, D, E});
    std::vector<af::Expression> input_dim_sizes{A, B, C, D, E};
  ...
  static std::shared_ptr<af::AscGraph> CreatSplitAscGraphSame(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatAddAscGraph(af::AscGraph &graph, size_t out_num = 1, size_t in_num = 1) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatAdd2InputsAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatAbsAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatConcatAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    const Expression C = graph.CreateSizeVar("C");
  ...
  static std::shared_ptr<af::AscGraph> CreatConcatAscGraph(af::AscGraph &graph, const std::vector<int64_t> &concat_dims,
                                                           size_t concat_dim) {
    auto ONE = Symbol(1);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
    ...
    std::vector<std::vector<af::Expression>> intput_dim_sizes(concat_dims.size(), {A, B, C, D, E});
    std::vector<af::Expression> output_dim_sizes{A, B, C, D, E};
    int64_t total_size = 0;
    ...
    for (size_t i = 0U; i < concat_dims.size(); ++i) {
      auto e_size = af::Symbol(concat_dims[i]);
  ...
  static std::shared_ptr<af::AscGraph> CreatBroadcastAbsAscGraphWith6Axis(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    auto ZERO = Symbol(0);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
  ...
  static std::shared_ptr<af::AscGraph> CreatBroadcastAbsAscGraphWith5Axis(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    auto ZERO = Symbol(0);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
  ...
  static std::shared_ptr<af::AscGraph> CreatBroadcastAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    auto ZERO = Symbol(0);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
  ...
  static std::shared_ptr<af::AscGraph> CreatGatherAscGraph(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    auto ZERO = Symbol(0);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
  ...
  static std::shared_ptr<af::AscGraph> CreatGatherAscGraphWithInvlaidAxis(af::AscGraph &graph) {
    auto ONE = Symbol(1);
    auto ZERO = Symbol(0);
    const Expression A = graph.CreateSizeVar("A");
    const Expression B = graph.CreateSizeVar("B");
  ...
  static Status SetAttrsGroup(const NodePtr &node) {
    ...
    af::AscGraph add_graph(node->GetName().c_str());
    ...
    for (const auto in_anchor : node->GetAllInDataAnchorsPtr()) {
      ...
      const auto attr_group = output_tensor_desc->GetOrCreateAttrsGroup<af::SymbolicDescAttr>();
