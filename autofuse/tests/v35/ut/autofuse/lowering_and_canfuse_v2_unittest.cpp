...
TEST_F(UTestLoweringAndCanfuseV2, A5TransposeAndElementwiseCanFuse) {
  ...
  [this]() {
    ...
    auto perms = CreateConst(*es_graph_, af::DT_INT64, {5}, std::vector<int64_t>{2, 1, 0, 4, 3});
...
TEST_F(UTestLoweringAndCanfuseV2, A5TransposeAndTransposeLoweringCanfuse) {
  ...
  [this]() {
    ...
    auto perms1 = CreateConst(*es_graph_, af::DT_INT64, {3}, std::vector<int64_t>{1, 0, 2});
...
TEST_F(UTestLoweringAndCanfuseV2, A5ElementwiseAndTransposeCanFuse) {
  ...
  [this]() {
    ...
    auto perms = CreateConst(*es_graph_, af::DT_INT64, {3}, std::vector<int64_t>{2, 1, 0});
...
TEST_F(UTestLoweringAndCanfuseV2, A5MutiRefEleAndTransposeNotFuse) {
  ...
  [this]() {
    ...
    auto perms = CreateConst(*es_graph_, af::DT_INT64, {3}, std::vector<int64_t>{2, 0, 1});
...
TEST_F(UTestLoweringAndCanfuseV2, SplitVLoweringCanfuseStatic) {
  ...
  [this]() {
    auto data0 = es_graph_->CreateInput(0, "data0", nullptr);
    data0.SetSymbolShape({"64", "96", "16"});
    auto size_splits = CreateConst(*es_graph_, af::DT_INT64, {1}, std::vector<int64_t>{32, 32, 32});
...
TEST_F(UTestLoweringAndCanfuseV2, SingleSplitVLiftingErrorStatic) {
  ...
  [this]() {
    ...
    auto size_splits = CreateConst(*es_graph_, af::DT_INT64, {1}, std::vector<int64_t>{96});
...
TEST_F(UTestLoweringAndCanfuseV2, GatherAddBroadcastFuse) {
  ...
  [this]() {
    ...
    auto axis = CreateConst(*es_graph_, af::DT_INT64, {1}, std::vector<int64_t>{0});
    axis.SetSymbolShape({});
...
static void BuildGatherGatherConcatGraph(es::Graph &es_graph) {
  ...
  multiples.SetSymbolShape({"3"});
  auto axis = CreateConst(es_graph, af::DT_INT64, {1}, std::vector<int64_t>{0});
  axis.SetSymbolShape({});
