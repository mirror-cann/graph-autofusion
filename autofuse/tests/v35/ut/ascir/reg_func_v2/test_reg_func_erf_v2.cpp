...
namespace af {
namespace ascir {
extern std::vector<std::unique_ptr<af::TmpBufDesc>> CalcErfTmpSizeV2(const af::AscNode &node);
...
TEST_F(CalcErfTmpSizeV2Test, CalcErfTmpSize_ShouldReturnCorrectSize_WhenInputsIsFLOAT) {
  ...
  *y.y.strides = {s1, Symbol(1)};
  ...
  std::vector<std::unique_ptr<af::TmpBufDesc>> result = CalcErfTmpSizeV2(*node);
