...
class TestApiZeta : public testing::Test {
 protected:
  ...
  static BinaryInputParam<float> BuildZetaTestData() {
    ...
    x_list.push_back(39.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(-INFINITY);
    x_list.push_back(40.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(INFINITY);
    x_list.push_back(41.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(-INFINITY);
    x_list.push_back(42.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(INFINITY);
    x_list.push_back(39.0f);
    q_list.push_back(-0.9f);
    exp_list.push_back(INFINITY);
    x_list.push_back(40.0f);
    q_list.push_back(-0.9f);
    exp_list.push_back(INFINITY);
    x_list.push_back(20.0f);
    q_list.push_back(-0.01f);
    exp_list.push_back(INFINITY);
    x_list.push_back(21.0f);
    q_list.push_back(-0.01f);
    exp_list.push_back(-INFINITY);
    x_list.push_back(128.0f);
    q_list.push_back(-1.5f);
    exp_list.push_back(INFINITY);
    x_list.push_back(128.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(INFINITY);
    x_list.push_back(129.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(-INFINITY);
    x_list.push_back(130.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(INFINITY);
    x_list.push_back(131.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(-INFINITY);
    x_list.push_back(3.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(-999.150391f);
    x_list.push_back(4.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(10002.306641f);
    x_list.push_back(5.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(-99998.882812f);
    x_list.push_back(20.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(1.0e20f);
    x_list.push_back(38.0f);
    q_list.push_back(-1.1f);
    exp_list.push_back(9.9999997e37f);
    x_list.push_back(2.0f);
    q_list.push_back(-0.3f);
    exp_list.push_back(13.945160f);
    x_list.push_back(3.0f);
    q_list.push_back(-0.3f);
    exp_list.push_back(-33.819542f);
    x_list.push_back(4.0f);
    q_list.push_back(-0.3f);
    exp_list.push_back(127.769981f);
    x_list.push_back(2.0f);
    q_list.push_back(-0.7f);
    exp_list.push_back(14.286180f);
    x_list.push_back(3.0f);
    q_list.push_back(-0.7f);
    exp_list.push_back(34.720818f);
    x_list.push_back(2.0f);
    q_list.push_back(-11.5f);
    exp_list.push_back(9.786319f);
    x_list.push_back(2.0f);
    q_list.push_back(-20.5f);
    exp_list.push_back(9.821995f);
    x_list.push_back(2.0f);
    q_list.push_back(-50.3f);
    exp_list.push_back(15.059730f);
    x_list.push_back(3.0f);
    q_list.push_back(-11.5f);
    exp_list.push_back(0.003466f);
    x_list.push_back(2.5f);
    q_list.push_back(-50.3f);
    exp_list.push_back(NAN);
    x_list.push_back(3.0f);
    ...
    x_list.push_back(5.0f);
    q_list.push_back(-1.5f);
    exp_list.push_back(0.013073f);
    x_list.push_back(3.0f);
    q_list.push_back(-2.5f);
    exp_list.push_back(0.054102f);
    x_list.push_back(5.0f);
    q_list.push_back(-2.5f);
    exp_list.push_back(0.002833f);
    x_list.push_back(3.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(0.414398f);
    x_list.push_back(5.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(0.144760f);
    x_list.push_back(7.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(0.060358f);
    x_list.push_back(2.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(8.934802f);
    x_list.push_back(4.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(32.234848f);
    x_list.push_back(10.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(2048.017334f);
    x_list.push_back(126.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(1.70141183e38f);
    x_list.push_back(127.0f);
    q_list.push_back(-0.5f);
    exp_list.push_back(4.32922447e-23f);
    x_list.push_back(2.5f);
    q_list.push_back(-1.1f);
    exp_list.push_back(NAN);
    x_list.push_back(3.5f);
    q_list.push_back(-0.3f);
    exp_list.push_back(NAN);
    x_list.push_back(2.0f);
    q_list.push_back(-2.0f);
    exp_list.push_back(INFINITY);
    x_list.push_back(3.0f);
    q_list.push_back(-5.0f);
    exp_list.push_back(INFINITY);
    x_list.push_back(30.0f);
    q_list.push_back(2.0f);
    exp_list.push_back(9.31322575e-10f);
    x_list.push_back(50.0f);
    q_list.push_back(2.0f);
    exp_list.push_back(8.8817842e-16f);
