...
extern "C" __global__ __aicore__ void trunc_bf16_test(GM_ADDR x0, GM_ADDR output, GM_ADDR workspace,
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_TruncBf16_Code, ::testing::Values(std::vector<int>{2, 8}));
