...
extern "C" __global__ __aicore__ void abs_clip_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR x3, GM_ADDR y, GM_ADDR workspace,
                                                    GM_ADDR tiling);
...
TEST_P(E2E_BackendAbsClip_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(abs_clip_test, tiling_data.block_dim, (uint8_t *)input, (uint8_t *)srcMin, (uint8_t *)srcMax,
