...
class TestBackendHypotFloatE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendHypotFloatE2e, HypotFloatE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::HypotFloatFusedGraph(2);
