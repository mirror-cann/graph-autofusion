...
extern "C" __global__ __aicore__ void tanh_bf16_test(GM_ADDR x0, GM_ADDR output, GM_ADDR workspace,
...
namespace {
class E2E_TanhBf16_Code : public testing::Test, public testing::WithParamInterface<std::vector<int>> {};

TEST_P(E2E_TanhBf16_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(tanh_bf16_test, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr, (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_TanhBf16_Code, ::testing::Values(std::vector<int>{2, 8}));
