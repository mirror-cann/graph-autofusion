...
class TestBackendLog1pBfloat16E2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLog1pBfloat16E2e, Log1pBfloat16E2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::Log1pBfloat16FusedGraph(2);
