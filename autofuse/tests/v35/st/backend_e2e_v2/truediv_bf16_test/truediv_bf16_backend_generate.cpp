...
class TestBackendTrueDivBf16E2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendTrueDivBf16E2e, TrueDivBf16E2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  // shape_info 和 TrueDivBf16FusedGraph入参dims_size匹配（个数相同，命名规则为s开头、编号从0开始）
  std::map<std::string, std::string> shape_info({{"s0", "stub_s0"}, {"s1", "stub_s1"}});
  auto graph = ascir::ShareGraph::TrueDivBf16FusedGraph(2);
