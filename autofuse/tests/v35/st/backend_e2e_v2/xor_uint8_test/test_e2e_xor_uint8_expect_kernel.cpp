...
extern "C" __global__ __aicore__ void xor_uint8_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace,
                                                     GM_ADDR tiling);
...
TEST_P(E2E_XorUint8_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(xor_uint8_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_XorUint8_Code, ::testing::Values(std::vector<int>{32, 16, 16}));
