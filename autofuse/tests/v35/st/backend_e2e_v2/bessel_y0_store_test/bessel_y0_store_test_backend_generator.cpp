...
class TestBackendBesselY0StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendBesselY0StoreE2e, BesselY0StoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::BesselY0StoreFusedGraph, "BesselY0Extend"));
}
