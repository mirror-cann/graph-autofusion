...
class TestBackendLgammaFloatE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLgammaFloatE2e, LgammaFloatE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LgammaFloatFusedGraph(2);
