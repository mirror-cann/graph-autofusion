...
class TestBackendScaledModifiedBesselK0StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendScaledModifiedBesselK0StoreE2e, ScaledModifiedBesselK0StoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ScaledModifiedBesselK0StoreFusedGraph,
                                         "ScaledModifiedBesselK0Extend", true));
}
