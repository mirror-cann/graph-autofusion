...
class TestBackendVfScalarUbScalarFusionE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendVfScalarUbScalarFusionE2e, VfScalarUbScalarFusionE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  // shape_info 保持为空，因为图中使用固定符号
  std::map<std::string, std::string> shape_info = {{"s0", "stub_s0"}, {"s1", "stub_s1"}};
  auto graph = ascir::ShareGraph::VfScalarFusionComprehensiveFusedGraph();
