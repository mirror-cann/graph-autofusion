...
extern "C" __global__ __aicore__ void binary_api_scalar_test(GM_ADDR x0, GM_ADDR x1, GM_ADDR y, GM_ADDR workspace,
                                                             GM_ADDR tiling);
...
TEST_P(E2E_BackendAddAbsHalfScalar_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(binary_api_scalar_test, tiling_data.block_dim, (uint8_t *)x0, (uint8_t *)x1, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
