...
extern "C" __global__ __aicore__ void load_bitwise_or_store_test(GM_ADDR x0, GM_ADDR x1, GM_ADDR y1, GM_ADDR workspace,
                                                                 GM_ADDR tiling);
...
class E2E_BackendLoadBitwiseOrStore_Code : public testing::Test,
...
TEST_P(E2E_BackendLoadBitwiseOrStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_bitwise_or_store_test, tiling_data.block_dim, (uint8_t *)x0, (uint8_t *)x1, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
