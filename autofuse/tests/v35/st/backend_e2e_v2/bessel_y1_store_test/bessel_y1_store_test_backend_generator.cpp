...
class TestBackendBesselY1StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendBesselY1StoreE2e, BesselY1StoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::BesselY1StoreFusedGraph, "BesselY1Extend"));
}
