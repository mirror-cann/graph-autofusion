...
class TestBackendShiftedChebyshevPolynomialWStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendShiftedChebyshevPolynomialWStoreE2e, ShiftedChebyshevPolynomialWStoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ShiftedChebyshevPolynomialWStoreFusedGraph,
                                         "ShiftedChebyshevPolynomialWExtend"));
}
