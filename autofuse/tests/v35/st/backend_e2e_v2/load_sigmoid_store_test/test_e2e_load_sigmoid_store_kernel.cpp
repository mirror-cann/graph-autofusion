...
extern "C" __global__ __aicore__ void load_sigmoid_store_test(GM_ADDR x1, GM_ADDR y1, GM_ADDR workspace,
                                                              GM_ADDR tiling);
...
TEST_P(E2E_BackendLoadSigmodStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_sigmoid_store_test, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
