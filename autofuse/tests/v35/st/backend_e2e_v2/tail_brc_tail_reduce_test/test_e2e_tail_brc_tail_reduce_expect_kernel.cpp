...
TEST_P(E2E_TailBrcTailReduce_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(tail_brc_tail_reduce_test, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_TailBrcTailReduce_Code,
                         ::testing::Values(std::vector<int>{4, 8, 7}));
