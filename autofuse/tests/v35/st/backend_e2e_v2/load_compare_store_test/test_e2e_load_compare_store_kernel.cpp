...
extern "C" __global__ __aicore__ void load_compare_store_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y1, GM_ADDR workspace,
                                                              GM_ADDR tiling);
...
TEST_P(E2E_BackendLoadCompareStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_compare_store_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y1, nullptr,
              (uint8_t *)&tiling_data);
