...
class TestBackendNdtrStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendNdtrStoreE2e, NdtrStoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::NdtrStoreFusedGraph, "NdtrExtend"));
}
