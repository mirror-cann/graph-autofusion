...
class TestBackendBesselJ1StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendBesselJ1StoreE2e, BesselJ1StoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::BesselJ1StoreFusedGraph, "BesselJ1Extend"));
}
