...
class TestBackendShiftedChebyshevPolynomialVStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendShiftedChebyshevPolynomialVStoreE2e, ShiftedChebyshevPolynomialVStoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ShiftedChebyshevPolynomialVStoreFusedGraph,
                                         "ShiftedChebyshevPolynomialVExtend"));
}
