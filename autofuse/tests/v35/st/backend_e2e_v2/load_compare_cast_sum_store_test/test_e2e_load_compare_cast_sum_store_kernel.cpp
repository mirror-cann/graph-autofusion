...
extern "C" __global__ __aicore__ void load_compare_cast_sum_store_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y1,
...
class E2E_BackendLoadCompareCastSumStore_Code : public testing::Test,
...
TEST_P(E2E_BackendLoadCompareCastSumStore_Code, CalculateCorrect) {
  ...
  printf("tiling key: %d, core_num: %d, ws_size: %u\n", tiling_data.graph0_tiling_key, tiling_data.block_dim, ws_size);

  AscendC::SetKernelMode(KernelMode::AIV_MODE);
  ICPU_RUN_KF(load_compare_cast_sum_store_test, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y1,
