...
class TestBackendFrexpFloatE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendFrexpFloatE2e, FrexpFloatE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::FrexpFloatFusedGraph(2);
