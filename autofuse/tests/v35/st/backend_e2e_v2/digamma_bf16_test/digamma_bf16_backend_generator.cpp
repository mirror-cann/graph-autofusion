...
class TestBackendDigammaBf16E2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendDigammaBf16E2e, DigammaBf16E2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::DigammaBf16FusedGraph(3);
