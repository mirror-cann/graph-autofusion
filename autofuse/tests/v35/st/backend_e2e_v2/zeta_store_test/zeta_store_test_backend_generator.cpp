...
class TestBackendZetaStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendZetaStoreE2e, ZetaStoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ZetaStoreFusedGraph, "ZetaExtend"));
}
