...
extern "C" __global__ __aicore__ void log10_float_test(GM_ADDR x, GM_ADDR output, GM_ADDR workspace,
                                                       GM_ADDR tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_Log10Float_Code, ::testing::Values(std::vector<int>{2, 8}));
