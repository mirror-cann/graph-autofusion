...
class TestBackendLog10FloatE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendLog10FloatE2e, Log10FloatE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::LoadLog10StoreFusedGraph(2);
