...
extern "C" __global__ __aicore__ void trunc_to_int_bf16_to_int32_test(GM_ADDR x, GM_ADDR y, GM_ADDR workspace,
                                                                      GM_ADDR tiling);
...
TEST_P(E2E_TruncToIntBf16ToInt32_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(trunc_to_int_bf16_to_int32_test, tiling_data.block_dim, (uint8_t *)x, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
