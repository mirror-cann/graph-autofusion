...
class TestBackendShiftedChebyshevPolynomialUStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendShiftedChebyshevPolynomialUStoreE2e, ShiftedChebyshevPolynomialUStoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ShiftedChebyshevPolynomialUStoreFusedGraph,
                                         "ShiftedChebyshevPolynomialUExtend"));
}
