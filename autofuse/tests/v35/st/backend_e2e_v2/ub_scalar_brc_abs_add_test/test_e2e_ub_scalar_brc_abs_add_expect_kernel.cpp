...
extern "C" __global__ __aicore__ void ub_scalar_brc_abs_add_test(GM_ADDR data, GM_ADDR scalar, GM_ADDR output,
...
TEST_P(E2E_UbScalarBrcAbsAdd_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(ub_scalar_brc_abs_add_test, tiling_data.block_dim, (uint8_t *)x0, (uint8_t *)x1, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_UbScalarBrcAbsAdd_Code, ::testing::Values(std::vector<int>{2, 8}));
