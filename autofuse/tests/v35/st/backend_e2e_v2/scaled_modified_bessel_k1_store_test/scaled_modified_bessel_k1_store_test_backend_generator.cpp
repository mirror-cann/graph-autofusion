...
class TestBackendScaledModifiedBesselK1StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendScaledModifiedBesselK1StoreE2e, ScaledModifiedBesselK1StoreE2eCodegen) {
  EXPECT_TRUE(GenerateSpecialStoreKernel(ascir::ShareGraph::ScaledModifiedBesselK1StoreFusedGraph,
                                         "ScaledModifiedBesselK1Extend", true));
}
