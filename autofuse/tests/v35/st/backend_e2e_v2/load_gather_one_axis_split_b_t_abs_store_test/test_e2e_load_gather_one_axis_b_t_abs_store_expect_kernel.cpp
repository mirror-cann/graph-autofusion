...
extern "C" __global__ __aicore__ void load_gather_one_axis_abs_store_store_test(GM_ADDR param, GM_ADDR indices,
...
TEST_P(E2E_Load_Gather_One_Axis_B_T_Abs_Store, Gather_B_T_AbsTest) {
  ...
  ICPU_RUN_KF(load_gather_one_axis_abs_store_store_test, tiling_data.block_dim, (uint8_t *)param, (uint8_t *)indices,
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2E_Load_Gather_One_Axis_B_T_Abs_Store,
                         ::testing::Values(std::vector<int>{2, 2}));
