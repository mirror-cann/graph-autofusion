...
extern "C" __global__ __aicore__ void load_logicalor_store_test(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace,
                                                                GM_ADDR tiling);
...
class E2E_BackendLoadLogicalOrStore_Code : public testing::Test,
...
TEST_P(E2E_BackendLoadLogicalOrStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_logicalor_store_test, tiling_data.block_dim, (uint8_t *)input1, (uint8_t *)input2, (uint8_t *)y,
