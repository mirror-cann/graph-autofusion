...
TEST_F(LoadAbsStoreTest, LoadAbsStoreCodegen) {
  ...
  af::AscGraph test_graph("load_abs_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("load_abs_store_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_abs_store");
