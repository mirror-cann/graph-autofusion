...
TEST_F(LoadScalarClipStoreTest, LoadScalarClipStoreCodegen) {
  ...
  af::AscGraph test_graph("load_scalar_clip_store");
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  std::vector<af::AscGraph> test_impl_graphs = {af::AscGraph("load_scalar_clip_store_general_0_nil_0_nil")};
  ...
  try {
    ...
    fused_schedule_result.fused_graph_name = af::AscendString("load_scalar_clip_store");
