...
extern "C" __global__ __aicore__ void load_scalar_clip_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR x3, GM_ADDR y,
...
TEST_P(E2E_LoadScalarClipStore_Code, CalculateCorrect) {
  ...
  ICPU_RUN_KF(load_scalar_clip_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)x3, (uint8_t *)y,
