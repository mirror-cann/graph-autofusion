...
extern "C" __global__ __aicore__ void load_sub_store(GM_ADDR x1, GM_ADDR x2, GM_ADDR y, GM_ADDR workspace,
                                                     GM_ADDR tiling);
...
TEST_P(E2E_LoadSubStore_Code, CalculateCorrect_Sub) {
  ...
  ICPU_RUN_KF(load_sub_store, tiling_data.block_dim, (uint8_t *)x1, (uint8_t *)x2, (uint8_t *)y, nullptr,
              (uint8_t *)&tiling_data);
