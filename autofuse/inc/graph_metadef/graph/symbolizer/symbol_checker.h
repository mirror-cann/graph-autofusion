 ...
 */
#define EXPECT_SYMBOL_EQ(e0, e1) af::sym::ExpectSymbolEq(e0, e1, __FILE__, __LINE__)
 ...
 * 反之，则返回false，并生成 e0 == e1的guard
 */
#define EXPECT_SYMBOL_NE(e0, e1) af::sym::ExpectSymbolNe(e0, e1, __FILE__, __LINE__)
 ...
 */
#define EXPECT_SYMBOL_LT(e0, e1) EXPECT_SYMBOL_CHECK(af::sym::Lt(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则返回false，并生成 e1 < e0的guard
 */
#define EXPECT_SYMBOL_LE(e0, e1) EXPECT_SYMBOL_CHECK(af::sym::Le(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则返回false，并生成 e0 <= e1的guard
 */
#define EXPECT_SYMBOL_GT(e0, e1) EXPECT_SYMBOL_CHECK(af::sym::Gt(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则返回false，并生成 e0 < e1的guard
 */
#define EXPECT_SYMBOL_GE(e0, e1) EXPECT_SYMBOL_CHECK(af::sym::Ge(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则报错
 */
#define ASSERT_SYMBOL_NE(e0, e1) ASSERT_SYMBOL_CHECK(af::sym::Ne(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则报错
 */
#define ASSERT_SYMBOL_LT(e0, e1) ASSERT_SYMBOL_CHECK(af::sym::Lt(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则报错
 */
#define ASSERT_SYMBOL_LE(e0, e1) ASSERT_SYMBOL_CHECK(af::sym::Le(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则报错
 */
#define ASSERT_SYMBOL_GT(e0, e1) ASSERT_SYMBOL_CHECK(af::sym::Gt(e0, e1), __FILE__, __LINE__)
 ...
 * 反之，则报错
 */
#define ASSERT_SYMBOL_GE(e0, e1) ASSERT_SYMBOL_CHECK(af::sym::Ge(e0, e1), __FILE__, __LINE__)

#define EXPECT_SYMBOL_CHECK(expr, file, line) af::sym::ExpectSymbolBool(expr, file, line)
...
class Expression;
namespace sym {
bool ExpectSymbolEq(const Expression &e0, const Expression &e1, const char *file, const int64_t line);
bool AssertSymbolEq(const Expression &e0, const Expression &e1, const char *file, const int64_t line);
bool ExpectSymbolNe(const Expression &e0, const Expression &e1, const char *file, const int64_t line);
bool ExpectSymbolBool(const Expression &expr, const char *file, const int64_t line);
bool AssertSymbolBool(const Expression &expr, const char *file, const int64_t line);
}  // namespace sym
}  // namespace af
