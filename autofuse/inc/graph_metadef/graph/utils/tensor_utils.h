...
class TensorUtils {
 public:
  ...
  static graphStatus GetDeviceType(const GeTensorDesc &tensor_desc, ge::DeviceType &type);
  static void SetDeviceType(GeTensorDesc &tensor_desc, const ge::DeviceType type);
