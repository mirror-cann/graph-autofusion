...
class OpDescUtils {
 public:
  ...
  static af::graphStatus GetInputIrIndexByInstanceIndex(const OpDescPtr &op_desc, size_t instance_index,
                                                        size_t &ir_index);
  static af::graphStatus GetOutputIrIndexByInstanceIndex(const OpDescPtr &op_desc, size_t instance_index,
                                                         size_t &ir_index);
