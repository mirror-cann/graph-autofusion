...
class GE_FUNC_DEV_VISIBILITY GE_FUNC_HOST_VISIBILITY Tensor {
 public:
  ...
  graphStatus SetOriginFormat(const af::Format &format);
  af::Format GetOriginFormat() const;
  ...
  graphStatus SetFormat(const af::Format &format);
  af::Format GetFormat() const;

  graphStatus SetDataType(const af::DataType &dtype);
  af::DataType GetDataType() const;

  graphStatus SetPlacement(const af::Placement &placement);
  af::Placement GetPlacement() const;
