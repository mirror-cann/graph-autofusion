...
class GE_FUNC_DEV_VISIBILITY GE_FUNC_HOST_VISIBILITY Operator {
 public:
  ...
  using OpNamedAttrs = af::NamedAttrs;
  ...
  using OpListNamedAttrs = std::vector<af::NamedAttrs>;
  ...
  // func type
  ATTRIBUTED_DEPRECATED(Operator &SetAttr(const char_t *, const af::NamedAttrs &))
  Operator &SetAttr(const std::string &name, const af::NamedAttrs &attr_value);
  ATTRIBUTED_DEPRECATED(graphStatus GetAttr(const char_t *, af::NamedAttrs &) const)
  graphStatus GetAttr(const std::string &name, af::NamedAttrs &attr_value) const;
  ATTRIBUTED_DEPRECATED(Operator &SetAttr(const char_t *, const std::vector<af::NamedAttrs> &))
  Operator &SetAttr(const std::string &name, const std::vector<af::NamedAttrs> &attr_value);
  ATTRIBUTED_DEPRECATED(graphStatus GetAttr(const char_t *, std::vector<af::NamedAttrs> &) const)
  graphStatus GetAttr(const std::string &name, std::vector<af::NamedAttrs> &attr_value) const;
  ...
  // func type
  Operator &SetAttr(const char_t *name, const af::NamedAttrs &attr_value);
  graphStatus GetAttr(const char_t *name, af::NamedAttrs &attr_value) const;
  Operator &SetAttr(const char_t *name, const std::vector<af::NamedAttrs> &attr_value);
  graphStatus GetAttr(const char_t *name, std::vector<af::NamedAttrs> &attr_value) const;
 ...
 protected:
  ...
  ATTRIBUTED_DEPRECATED(void AttrRegister(const char_t *, const af::NamedAttrs &))
  void AttrRegister(const std::string &name, const af::NamedAttrs &attr_value);
  ATTRIBUTED_DEPRECATED(void AttrRegister(const char_t *, const std::vector<af::NamedAttrs> &))
  void AttrRegister(const std::string &name, const std::vector<af::NamedAttrs> &attr_value);
  ATTRIBUTED_DEPRECATED(void AttrRegister(const char_t *, const AscendString &))
  ...
  void AttrRegister(const char_t *name, const af::NamedAttrs &attr_value);
  void AttrRegister(const char_t *name, const std::vector<af::NamedAttrs> &attr_value);
