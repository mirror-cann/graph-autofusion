...
#define CHECK_NOTNULL_WITH_THROW_EXCEPTION(val, ...) ASCIR_ASSERT_NOTNULL(val, __VA_ARGS__)

#define CHECK_BOOL_WITH_THROW_EXCEPTION(val, ...) ASCIR_ASSERT((val), __VA_ARGS__)
