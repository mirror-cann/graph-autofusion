...
enum class MatchPolicyType { MATCH_POLICY_EXACT_ONLY = 0, MATCH_POLICY_FOR_EXACTLY_THE_SAME = 1 };
enum class AgingPolicyType { AGING_POLICY_LRU = 0, AGING_POLICY_LRU_K = 1 };
