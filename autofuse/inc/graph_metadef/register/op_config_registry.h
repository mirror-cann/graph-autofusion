...
#define REGISTER_OP_AICORE_CONFIG(opType, socVersion, opFunc) \
  REGISTER_OP_AICORE_CONFIG_UNIQ_HELPER(opType, socVersion, (opFunc), __COUNTER__)

#define REGISTER_OP_AICORE_CONFIG_UNIQ_HELPER(opType, socVersion, opFunc, counter) \
  REGISTER_OP_AICORE_CONFIG_UNIQ(opType, socVersion, (opFunc), counter)
