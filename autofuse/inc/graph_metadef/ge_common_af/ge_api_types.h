...
using RunAsyncCallback = std::function<void(Status, std::vector<af::Tensor> &)>;
...
static const char_t *const INPUT_SHAPE_RANGE = af::INPUT_SHAPE_RANGE;
...
static const char_t *const INSERT_OP_FILE = af::INSERT_OP_FILE.c_str();
static const char_t *const PRECISION_MODE = af::PRECISION_MODE.c_str();
static const char_t *const PRECISION_MODE_V2 = af::PRECISION_MODE_V2.c_str();
static const char_t *const TUNE_DEVICE_IDS = af::TUNE_DEVICE_IDS.c_str();
static const char_t *const EXEC_DISABLE_REUSED_MEMORY = af::OPTION_EXEC_DISABLE_REUSED_MEMORY;
static const char_t *const AUTO_TUNE_MODE = af::AUTO_TUNE_MODE.c_str();
static const char_t *const CORE_TYPE = af::CORE_TYPE.c_str();
static const char_t *const SOC_VERSION = af::SOC_VERSION.c_str();
static const char_t *const VIRTUAL_TYPE = af::VIRTUAL_TYPE.c_str();
static const char_t *const ENABLE_SINGLE_STREAM = af::ENABLE_SINGLE_STREAM;
static const char_t *const AC_PARALLEL_ENABLE = af::AC_PARALLEL_ENABLE.c_str();
static const char_t *const AICORE_NUM = af::AICORE_NUM.c_str();
static const char_t *const FUSION_SWITCH_FILE = af::FUSION_SWITCH_FILE.c_str();
static const char_t *const ENABLE_SMALL_CHANNEL = af::ENABLE_SMALL_CHANNEL.c_str();
static const char_t *const OP_SELECT_IMPL_MODE = af::OP_SELECT_IMPL_MODE.c_str();
static const char_t *const OUTPUT_TYPE = af::OUTPUT_DATATYPE.c_str();
static const char_t *const BUFFER_OPTIMIZE = af::BUFFER_OPTIMIZE.c_str();
static const char_t *const ENABLE_COMPRESS_WEIGHT = af::ENABLE_COMPRESS_WEIGHT.c_str();
static const char_t *const SPARSITY = af::ENABLE_SPARSE_MATRIX_WEIGHT.c_str();
static const char_t *const COMPRESS_WEIGHT_CONF = "compress_weight_conf";
static const char_t *const OUT_NODES = af::OUTPUT_NODE_NAME.c_str();
static const char_t *const INPUT_FP16_NODES = af::INPUT_FP16_NODES.c_str();
static const char_t *const LOG_LEVEL = "log";
static const char_t *const OPTYPELIST_FOR_IMPLMODE = af::OPTYPELIST_FOR_IMPLMODE.c_str();
static const char_t *const DEBUG_DIR = af::DEBUG_DIR;
static const char_t *const OP_COMPILER_CACHE_DIR = af::OP_COMPILER_CACHE_DIR;
static const char_t *const OP_COMPILER_CACHE_MODE = af::OP_COMPILER_CACHE_MODE;
static const char_t *const BUILD_INNER_MODEL = af::BUILD_INNER_MODEL;
static const char_t *const MDL_BANK_PATH = af::MDL_BANK_PATH_FLAG.c_str();
static const char_t *const OP_BANK_PATH = af::OP_BANK_PATH_FLAG.c_str();
static const char_t *const OP_BANK_UPDATE = af::OP_BANK_UPDATE_FLAG.c_str();
static const char_t *const OP_DEBUG_LEVEL = af::OP_DEBUG_LEVEL.c_str();
static const char_t *const PERFORMANCE_MODE = af::PERFORMANCE_MODE.c_str();
static const char_t *const SHAPE_GENERALIZED_BUILD_MODE = af::SHAPE_GENERALIZED_BUILD_MODE.c_str();
static const char_t *const MODIFY_MIXLIST = af::MODIFY_MIXLIST.c_str();
static const char_t *const OP_PRECISION_MODE = af::OP_PRECISION_MODE.c_str();
static const char_t *const ALLOW_HF32 = af::ALLOW_HF32.c_str();
...
static const char_t *const EXTERNAL_WEIGHT = af::EXTERNAL_WEIGHT.c_str();
static const char_t *const EXCLUDE_ENGINES = af::EXCLUDE_ENGINES.c_str();
static const char_t *const DETERMINISTIC = af::DETERMINISTIC.c_str();
static const char_t *const DETERMINISTIC_LEVEL = af::DETERMINISTIC_LEVEL.c_str();
static const char_t *const DISTRIBUTED_CLUSTER_BUILD = af::DISTRIBUTED_CLUSTER_BUILD.c_str();
static const char_t *const MODEL_RELATION_CONFIG = af::MODEL_RELATION_CONFIG.c_str();
static const char_t *const CLUSTER_CONFIG = af::CLUSTER_CONFIG.c_str();
...
static const char_t *const QUANT_DUMPABLE = af::QUANT_DUMPABLE.c_str();
static const char_t *const QUANT_BIAS_OPTIMIZE = af::QUANT_BIAS_OPTIMIZE.c_str();
static const char_t *const OP_DEPENDENCY_IN_OM = af::OPTION_OP_DEPENDENCY_IN_OM;
static const char_t *const OP_DEBUG_OPTION = af::OP_DEBUG_OPTION.c_str();
static const char_t *const TILING_SCHEDULE_OPTIMIZE = af::TILING_SCHEDULE_OPTIMIZE.c_str();
static const char_t *const GRAPH_MAX_PARALLEL_MODEL_NUM = af::GRAPH_MAX_PARALLEL_MODEL_NUM.c_str();
static const char_t *const OO_LEVEL = af::OO_LEVEL;
static const char_t *const OO_CONSTANT_FOLDING = af::OO_CONSTANT_FOLDING;
static const char_t *const OO_DEAD_CODE_ELIMINATION = af::OO_DEAD_CODE_ELIMINATION;
static const char_t *const OPTION_EXPORT_COMPILE_STAT = af::OPTION_EXPORT_COMPILE_STAT;
static const char_t *const OPTIMIZATION_SWITCH = af::OPTIMIZATION_SWITCH;
static const char_t *const INPUT_HINT_SHAPE = af::INPUT_HINT_SHAPE;
static const char_t *const OPTION_OUTPUT_REUSE_INPUT_MEM_INDEXES = af::OPTION_OUTPUT_REUSE_INPUT_MEM_INDEXES;
