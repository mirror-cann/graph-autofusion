...
#ifndef AIR_CXX_COMPILER_GRAPH_OPTIMIZE_AUTOFUSE_INC_FUSION_LOOP_TYPES_H_
#define AIR_CXX_COMPILER_GRAPH_OPTIMIZE_AUTOFUSE_INC_FUSION_LOOP_TYPES_H_
...
inline std::string StrJoin(const std::vector<af::Expression> &vec, const std::string &sep = ", ") {
  return StrJoin(vec, [](const af::Expression &s) { return std::string(s.Str().get()); }, sep);
}
...
#endif  // AIR_CXX_COMPILER_GRAPH_OPTIMIZE_AUTOFUSE_INC_FUSION_LOOP_TYPES_H_
