...
bool UseSmallTailConcatApi(const af::AscNode &node, bool *output_need_align = nullptr);
...
bool AreAllInputsFromPosition(const af::AscNodePtr &node, af::Position position);
