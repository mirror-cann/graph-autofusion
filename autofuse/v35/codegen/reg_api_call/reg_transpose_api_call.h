 ...
 */
#ifndef __AUTOFUSE_TRANSPOSE_API_CALL_H__
#define __AUTOFUSE_TRANSPOSE_API_CALL_H__
#include "codegen_kernel.h"

namespace codegen {
class TransposeRegApiCall final : public ApiCall {
 public:
  using ApiCall::Generate;
  explicit TransposeRegApiCall(const std::string &api_name) : ApiCall(api_name) {}
  ~TransposeRegApiCall() override = default;
