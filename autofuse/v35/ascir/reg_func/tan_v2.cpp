...
CalcTanTmpSizeV2(const AscNode &node) {
  ...
  uint32_t calc_tmp_buf = TAN_ONE_REPEAT_BYTE_SIZE * (node_inputs[0].attr.dtype == ge::DT_FLOAT16
                          ? TAN_HALF_CALC_PROC : TAN_FLOAT_CALC_PROC);
