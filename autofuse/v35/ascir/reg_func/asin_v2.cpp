...
CalcAsinTmpSizeV2(const AscNode &node) {
  ...
  uint32_t calc_tmp_buf = ASIN_ONE_REPEAT_BYTE_SIZE * (node_inputs[0].attr.dtype == ge::DT_FLOAT16
                          ? ASIN_HALF_CALC_PROC : ASIN_FLOAT_CALC_PROC);
