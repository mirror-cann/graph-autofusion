...
constexpr float Y1_YP[6] = {
    ...
    -8.12770255501325109621e+15, +2.02439475713594898196e+17, -7.78877196265950026825e+17,
};

constexpr float Y1_YQ[8] = {
    +5.94301592346128195359e+02, +2.35564092943068577943e+05, +7.34811944459721705660e+07, +1.87601316108706159478e+10,
    +3.88231277496238566008e+12, +6.20557727146953693363e+14, +6.87141087355300489866e+16, +3.97270608116560655612e+18,
};
...
__aicore__ inline void BesselY1Extend(const LocalTensor<T> &dst, const LocalTensor<T> &src,
  ...
  BesselY1ImplVF<T>((__ubuf__ T *)dst.GetPhyAddr(), (__ubuf__ T *)src.GetPhyAddr(), calCount);
}
