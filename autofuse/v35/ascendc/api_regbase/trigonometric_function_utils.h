...
template <typename T>
__simd_callee__ inline void CommonCalInSinCos(Reg::RegTensor<T> &dstReg, Reg::RegTensor<T> &x, Reg::RegTensor<T> &round,
...
template <typename T>
__simd_callee__ inline void AutofuseSin(Reg::RegTensor<T> &dstReg, Reg::RegTensor<T> &srcReg, Reg::MaskReg mask) {
...
template <typename T>
__simd_callee__ inline void AutofuseCos(Reg::RegTensor<T> &dstReg, Reg::RegTensor<T> &srcReg, Reg::MaskReg mask) {
  static_assert(SupportType<T, float>(), "Current data type is not support in current function!");
  Reg::RegTensor<T> x, round, kpi;
