...
__simd_callee__ inline void ErfcxPolyP(
    Reg::RegTensor<float>& pReg, Reg::RegTensor<float>& tReg, Reg::MaskReg& mask)
{
...
__simd_callee__ inline void ErfcxPolyA(
    Reg::RegTensor<float>& polyReg, Reg::RegTensor<float>& zReg, Reg::MaskReg& mask)
{
    Reg::RegTensor<float> tmpReg;
