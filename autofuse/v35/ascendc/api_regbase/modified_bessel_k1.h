...
constexpr float K1_A[11] = {
    ...
    -2.21338763073472585583e-08, -2.43340614156596823496e-06, -1.73028895751305206302e-04, -6.97572385963986435018e-03,
    -1.22611180822657148235e-01, -3.53155960776544875667e-01, +1.52530022733894777053e+00,
};
...
constexpr float K1_B[25] = {
    ...
    -2.12996783842756842877e-11, +9.21831518760500529508e-11, -4.19035475934189648750e-10, +2.01504975519703286596e-09,
    -1.03457624656780970260e-08, +5.74108412545004946722e-08, -3.50196060308781257119e-07, +2.40648494783721712015e-06,
    -1.93619797416608296024e-05, +1.95215518471351631108e-04, -2.85781685962277938680e-03, +1.03923736576817238437e-01,
...
template <typename T>
__simd_vf__ inline void ModifiedBesselK1ImplVF(__ubuf__ T *dst, __ubuf__ T *src, __ubuf__ T *tmpBuf,
                                               uint32_t calCount) {
...
__aicore__ inline void ModifiedBesselK1Extend(const LocalTensor<T> &dst, const LocalTensor<T> &src,
  ...
  ModifiedBesselK1ImplVF<T>((__ubuf__ T *)dst.GetPhyAddr(), (__ubuf__ T *)src.GetPhyAddr(),
