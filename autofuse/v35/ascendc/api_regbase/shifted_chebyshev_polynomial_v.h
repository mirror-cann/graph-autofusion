...
template <typename T, int64_t N>
__aicore__ inline void ShiftedChebyshevPolynomialVExtend(
    ...
    if constexpr (N < 0) {
        ...
        VF_CALL<ShiftedChebyshevPolynomialVCal<T, N>>(
            (__ubuf__ T*)dst.GetPhyAddr(), (__ubuf__ T*)src.GetPhyAddr(), calCount);
    }
}
