...
__simd_callee__ inline void SeriesComplementIter(Reg::RegTensor<float> &facReg, Reg::RegTensor<float> &sumReg,
...
__simd_callee__ inline void Igammac_helper_series_complement_float(Reg::RegTensor<float> &dstReg,
