...
__simd_callee__ inline void Igammac_compute_ans_float(Reg::RegTensor<float> &ansReg, Reg::RegTensor<float> &cReg,
...
__simd_callee__ inline void Igammac_helper_continued_fraction_float(Reg::RegTensor<float> &dstReg,
