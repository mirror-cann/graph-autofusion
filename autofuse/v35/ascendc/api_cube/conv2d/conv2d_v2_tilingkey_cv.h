...
#include "arch35/conv_tilingkey.h"
#endif
...
#if (defined(CV_UB_FUSION) || defined(CV_SAFETY_FUSION))
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_ONLY_MN_FULLLOAD_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_NO_FULLLOAD_AL0_OPEN_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_NO_FULLLOAD_BL0_OPEN_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_NO_FULLLOAD_ALL_OPEN_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_ONLY_AL1_FULLLOAD_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_ONLY_BL1_FULLLOAD_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_ABL1_FULLLOAD_M_FIRST_SEL()),
ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), CONV_INNER_BATCH_ABL1_FULLLOAD_N_FIRST_SEL()),
#else
