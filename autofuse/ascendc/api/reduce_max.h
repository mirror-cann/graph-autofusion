...
template <typename T>
__aicore__ inline void BrcbReduceToSingle(const LocalTensor<T> &dst, const LocalTensor<T> &src,
                                          const LocalTensor<T> &tmpBuffer, uint32_t count) {
...
template <typename T>
__aicore__ inline void BinaryReduceToSingle(const LocalTensor<T> &dst, const LocalTensor<T> &src,
                                            const LocalTensor<T> &tmpBuffer, uint32_t count) {
...
__aicore__ inline void ReduceMaxARProcessRow(const LocalTensor<int32_t> &rowDst, const LocalTensor<int32_t> &rowSrc,
                                             const LocalTensor<int32_t> &workBuffer, uint32_t lastAxis) {
...
__aicore__ inline void ReduceMaxInt32AR(const LocalTensor<int32_t> &dstTensor, const LocalTensor<int32_t> &srcTensor,
                                        const LocalTensor<int32_t> &tmpTensor, uint32_t firstAxis, uint32_t lastAxis,
                                        uint32_t padLast) {
  constexpr uint32_t elePerBlk = INT32_ELEM_PER_BLK;
...
template <bool isReuseSource = false>
__aicore__ inline void ReduceMaxInt32RA(const LocalTensor<int32_t> &dstTensor, const LocalTensor<int32_t> &srcTensor,
                                        const LocalTensor<int32_t> &tmpTensor, uint32_t firstAxis, uint32_t lastAxis,
                                        uint32_t padLast) {
  BinaryRepeatParams defaultParam;
  UnaryRepeatParams defaultUnaryParam;
...
__aicore__ inline void ReduceMaxExtendImpl(const LocalTensor<int32_t> &dstTensor, const LocalTensor<int32_t> &srcTensor,
...
__aicore__ inline void ReduceMaxExtend(const AscendC::LocalTensor<T> &dstTensor,
                                       ...
                                       const AscendC::LocalTensor<uint8_t> &sharedTmpBuffer, const uint32_t srcShape[],
  ...
  AscendC::__AutoFusionApiImpl::ReduceMaxExtendImpl<pattern, isReuseSource>(dstTensor, srcTensor, sharedTmpBuffer,
                                                                            srcShape, srcInnerPad);
}
