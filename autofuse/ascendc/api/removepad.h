...
template <typename T>
inline __aicore__ void RemovePadExtend(const LocalTensor<T> &dst, const LocalTensor<T> &src,
                                       const uint64_t last_axis_actual_size, const uint64_t last_axis_size,
