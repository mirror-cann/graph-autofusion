...
class InductorCompileDuration:
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        ascendc_compile.record_inductor_compile_duration(
...
def compile_core(sources, argv: List[str], stage='all', tiling_repr=None, trace_stage=None):
    ...
    try:
        ...
        ascendc_compile.record_inductor_compile_duration(args.trace_stage, "PrepareCompileContext", args.graph_name,
        ...
        if args is not None:
            ...
            ascendc_compile.record_inductor_compile_duration(args.trace_stage, "Total", args.graph_name,
