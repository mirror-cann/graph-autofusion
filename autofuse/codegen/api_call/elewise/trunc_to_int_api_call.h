 ...
 */
#ifndef __AUTOFUSE_TRUNC_TO_INT_API_CALL_H__
#define __AUTOFUSE_TRUNC_TO_INT_API_CALL_H__
#include "codegen_kernel.h"

namespace af { namespace codegen {
class TruncToIntApiCall : public ApiCall {
 public:
  using ApiCall::Generate;
  explicit TruncToIntApiCall(const std::string &api_name) : ApiCall(api_name) {}
  ~TruncToIntApiCall() final = default;
