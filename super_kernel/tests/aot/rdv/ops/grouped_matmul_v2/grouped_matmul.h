...
class GMMProcess {
 ...
 public:
    ...
    __aicore__ inline void Init(const GMMBaseParams* __restrict gmmBaseParamsIn,
                                ...
                                GM_ADDR groupList, const GMMTilingData* tiling);
...
__aicore__ inline void GMMProcess<ComputeType>::Init(const GMMBaseParams* __restrict gmmBaseParamsIn,
    const TCubeTiling* __restrict mmTilingDataIn, TILING_TYPE* gmmArrayAddrIn, GM_ADDR groupList, const GMMTilingData* tiling) {
...
*/
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync = false>
class GMMCompute {
 public:
...
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::Init(GM_ADDR x, GM_ADDR weight, GM_ADDR bias, GM_ADDR scale,
...
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::SetGlobalBufferBias(uint32_t groupIdx,
...
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline uint64_t GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::SetWOffset(uint32_t tailN, uint32_t k) {
    uint64_t wOffset = 0;
...
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline GlobalTensor<typename mmType::BT::T> GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::SetGlobalBufferW(
...
template <class mmType, typename DTYPE_WEIGHT, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::MMCompute(uint32_t groupIdx, MNConfig& mnConfig, uint32_t coreIdx) {
    if (subBlockIdx != 0) {
        return;
    }
