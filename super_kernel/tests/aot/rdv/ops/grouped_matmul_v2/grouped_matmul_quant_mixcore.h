...
*/
template <class mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync = false>
class GMMQuantMixCoreCompute : public GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync> {
 public:
    ...
    /** @brief constructor */
    __aicore__ inline GMMQuantMixCoreCompute(typename mmType::MT& mm_) : GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>(mm_) {}
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::Init(GM_ADDR x, GM_ADDR weight, GM_ADDR bias,
                                                                  ...
                                                                  TPipe* tPipe) {
    this->GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::Init(x, weight, bias, scale, offset, antiquantScale, antiquantOffset, groupList,
    ...
    if (mmTilingData != nullptr) {
        ...
        if (this->GMMCompute<mmType, DTYPE_WEIGHT, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::isA8W4FakeQuant == true) {
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::InitStaticTiling(const GMMBaseParams* __restrict gmmBaseParams, 
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::PostCompute() {
    if ASCEND_IS_AIC {
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::MMCompute(uint32_t groupIdx, MNConfig& mnConfig,
                                                                       uint32_t coreIdx) {
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::VectorCompute(MNConfig& mnConfig) {
    nOffset = 0;
    uint32_t tailN = mnConfig.nIdx * mnConfig.singleN;
    uint32_t curSingleN = mnConfig.nIdx < mnConfig.blockDimN - 1 ? mnConfig.singleN : mnConfig.n - tailN;
    uint32_t curSingleM = mnConfig.mIdx < mnConfig.blockDimM - 1 ? mnConfig.singleM
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::ComputeDequantAndActivate(MNConfig& mnConfig, 
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::PerTokenQuant(uint32_t curVecBaseM, uint32_t alignBaseN)
{
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::VectorTilingCalc(
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::Dequant(MNConfig& mnConfig) {
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::DataCopyOut(MNConfig& mnConfig, uint32_t curVecBaseM,
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::ActivationCompute(uint32_t computeSize,
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::SetPerTokenQuantStaticBuffer(
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::SetPerTokenQuantRefreshedBuffer(const MNConfig mnConfig) {
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::DataCopyScale(uint32_t curBaseN,
                                                                           uint32_t alignBaseN,
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::DataCopyBias(uint32_t curBaseN, uint32_t alignBaseN,
                                                                          uint64_t biasOffset)
{
...
template <typename mmType, typename DTYPE_WEIGHT, typename MM_DTYPE_Y, typename DTYPE_Y, typename DTYPE_SCALE, typename DTYPE_BIAS, bool sync>
__aicore__ inline void GMMQuantMixCoreCompute<mmType, DTYPE_WEIGHT, MM_DTYPE_Y, DTYPE_Y, DTYPE_SCALE, DTYPE_BIAS, sync>::DataCopyPerTokenScaleAndBrcb(MNConfig& mnConfig,
                                                                                          uint32_t curBaseM,
                                                                                          uint32_t alignBaseN,
                                                                                          uint32_t offsetM)
{
