...
set(GTEST_PATH "${GRAPH_AUTOFUSION_ROOT_DIR}/super_kernel/tests/aot/third_party/")
set(GTEST_INSTALL_PATH ${GTEST_PATH}/gtest)
...
if(gtest_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    set(GTEST_LOCAL_SRC "${GTEST_PATH}/../llt/third_party/gtest/googletest-1.10.x")
    set(GTEST_OPTS
