...
protected:
    ...
    SuperKernelProcessedScopeInfo scopeInfo;
...
TEST_F(SkProfilingTest, NumBlocks_Encoding_Mix11) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 1).release());
...
TEST_F(SkProfilingTest, AttrId_SingleNode) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 1, 12345, 0).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
...
TEST_F(SkProfilingTest, AttrId_MultipleNodes) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 1, 100, 0).release());
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(2, 1, 200, 0).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
...
TEST_F(SkProfilingTest, OpFlag_SingleNode) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 1, 0, 5).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
...
TEST_F(SkProfilingTest, OpFlag_Aggregation) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 1, 0, 1).release());
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(2, 1, 0, 2).release());
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(3, 1, 0, 4).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
...
TEST_F(SkProfilingTest, TensorNum_SingleNode) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 3).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
...
TEST_F(SkProfilingTest, TensorNum_MultipleNodes) {
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(1, 2).release());
    scopeInfo.nodes.push_back(CreateKernelNodeWithCacheInfo(2, 3).release());
    launchInfo.entryInfo.numBlocks = 8;
    launchInfo.entryInfo.entryType = SkKernelType::AIC_ONLY;
