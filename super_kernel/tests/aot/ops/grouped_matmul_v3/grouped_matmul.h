...
class GMMProcess {
 ...
 public:
    ...
    __aicore__ inline void Init(const GMMBaseParams* __restrict gmmBaseParamsIn,
                                const TCubeTiling* __restrict mmTilingDataIn, const GMMArray* __restrict gmmArrayAddrIn,
...
__aicore__ inline void GMMProcess<ComputeType>::Init(const GMMBaseParams* __restrict gmmBaseParamsIn,
    const TCubeTiling* __restrict mmTilingDataIn, const GMMArray* __restrict gmmArrayAddrIn, GM_ADDR groupList, const GMMTilingData* tiling) {
    ...
    mListGm = (TILING_TYPE*)gmmArrayAddrIn;
    kListGm = (TILING_TYPE*)gmmArrayAddrIn + MKN_LIST_LEN;
    nListGm = (TILING_TYPE*)gmmArrayAddrIn + MKN_LIST_LEN * 2;
}
