...
`sk-model-analysis` 是面向 `SuperKernel` 结果目录的诊断与可视化工具集。
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py <subcommand> <input>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py --help
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --help
python <skills_root>/sk-model-analysis/scripts/model_analysis.py diagnose-hang-crash --help
python <skills_root>/sk-model-analysis/scripts/model_analysis.py diagnose-performance --help
python <skills_root>/sk-model-analysis/scripts/model_analysis.py trace-nodes --help
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze <result_root_or_model_dir>
```
...
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --profile <input>

# 指定并行 worker 数。默认会按 model 数和 CPU 数自动扩展
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --jobs 96 <input>

# 禁用 parser cache，用于确认真实解析路径
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --no-cache <input>

# 禁用多进程，排查并发相关问题时使用
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --no-parallel <input>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py diagnose-hang-crash <result_root_or_model_dir>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py diagnose-performance <result_root_or_model_dir>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py trace-nodes <result_root_or_model_dir>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/sk_library_extractor.py <result_root_or_model_dir>
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/sk_library_extractor.py <input> -o <output_dir>
```

### 只生成 Scope View

```bash
python <skills_root>/sk-model-analysis/scripts/sk_scope_visualizer.py <result_root_or_model_dir> -o scope-graph.html
```

或者直接指定库文件：

```bash
python <skills_root>/sk-model-analysis/scripts/sk_scope_visualizer.py \
...
```bash
python <skills_root>/sk-model-analysis/scripts/sk_task_queue_visualizer.py <result_root_or_model_dir> -o task-queue-graph.html
```

或者直接指定库文件：

```bash
python <skills_root>/sk-model-analysis/scripts/sk_task_queue_visualizer.py \
  --scope-library <scope-library.json> \
  --graph-library <graph-library.json> \
...
```bash
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze <input> --with-ai
```
...
```bash
python <skills_root>/sk-model-analysis/scripts/regression_runner.py <sample_root>
```
...
python <skills_root>/sk-model-analysis/scripts/model_analysis.py analyze --profile --no-cache "$tmp_dir"
```
...
- [scripts/model_analysis.py](./scripts/model_analysis.py)
- [scripts/sk_library_extractor.py](./scripts/sk_library_extractor.py)
