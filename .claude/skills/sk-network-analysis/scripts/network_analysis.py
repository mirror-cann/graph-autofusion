...
def cmd_analyze(args: argparse.Namespace) -> int:
    return _run_diagnose("full", args.input, args.with_ai, args.jobs, args.no_parallel, args.no_cache, args.profile)


def cmd_diagnose_hang_crash(args: argparse.Namespace) -> int:
    return _run_diagnose("hang", args.input, args.with_ai, args.jobs, args.no_parallel, args.no_cache, args.profile)


def cmd_diagnose_performance(args: argparse.Namespace) -> int:
    return _run_diagnose("performance", args.input, args.with_ai, args.jobs, args.no_parallel, args.no_cache, args.profile)


def cmd_trace_nodes(args: argparse.Namespace) -> int:
    return _run_diagnose("trace", args.input, args.with_ai, args.jobs, args.no_parallel, args.no_cache, args.profile)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze.add_argument("--no-parallel", action="store_true", help="Disable multi-process execution even in multi-model mode")
    ...
    hang.add_argument("--no-parallel", action="store_true", help="Disable multi-process execution even in multi-model mode")
    ...
    perf.add_argument("--no-parallel", action="store_true", help="Disable multi-process execution even in multi-model mode")
    ...
    trace.add_argument("--no-parallel", action="store_true", help="Disable multi-process execution even in multi-model mode")
